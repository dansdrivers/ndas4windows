...
const LPCWSTR xDiMsiProcessActionNames[] = {
	L"xDiMsiInitialize",
	L"xDiInstallFromInfSection",
	L"xDiInstallLegacyPnpDevice",
	L"xDiInstallPnpDeviceInf",
	L"xDiInstallNetworkComponent",
	L"xDiUninstallPnpDevice",
	L"xDiUninstallNetworkComponent",
	L"xDiCleanupOEMInf",
	L"xDiStartService",
	L"xDiStopService",
	L"xDiQueueScheduleReboot",
	L"xDiCheckServicesInfSection"
};

C_ASSERT(_XDIMSI_PROCESS_TYPE_INVALID == RTL_NUMBER_OF(xDiMsiProcessActionNames));
...
typedef struct _XDIMSI_PROCESS_DATA {
	...
	ULONG RegNameOffset;
	ULONG RegNameLength;
	ULONG ActionDataOffset;
	ULONG ActionDataLength;
	ULONG ActionOffset;
	ULONG ActionLength;
