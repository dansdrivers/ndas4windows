...
NTSTATUS
NdasFatSecondaryCommonQueryQuota (
...
NTSTATUS
NdasFatSecondaryCommonSetQuota (
    IN PIRP_CONTEXT IrpContext,
    IN PIRP Irp
    )
{
...
NTSTATUS
NdasFatSecondaryCommonQuerySecurityInfo (
	IN PIRP_CONTEXT IrpContext,
	IN PIRP Irp
	)
{
...
NTSTATUS
NdasFatSecondaryCommonSetSecurityInfo (
	IN PIRP_CONTEXT IrpContext,
	IN PIRP Irp
	)
{
	...
	try {
		...
		DebugTrace2( 0, Dbg, ("NdasFatSecondaryCommonSetSecurityInfo: The length of the security desc:%lu\n",securityLength) );
    ...
    )
{
	...
	try {
		...
		DebugTrace2( 0, Dbg,
			("NdasFatSecondaryCommonQueryEa: BooleanFlagOn(IrpSp->Flags, SL_INDEX_SPECIFIED) = %d queryEa.EaIndex = %d queryEa.EaList = %p queryEa.Length = %d, inputBufferLength = %d\n",
    ...
    )
{
	...
	try {
		...
		DebugTrace2( 0, Dbg,
					("NdasFatSecondaryCommonSetEa: Ea is set setEa->Length = %d, inputBufferLength = %d\n",
