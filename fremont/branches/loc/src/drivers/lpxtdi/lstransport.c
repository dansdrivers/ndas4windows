...
LstransSend(
	...
	return ConnectionFile->Protocol->LstransFunc.LstransSend( // call to LpxTdiSend_LSTrams
					ConnectionFile->ConnectionFileObject,
					SendBuffer,
					SendLength,
					Flags,
...
LstransQueryInformation(
	...
	if(!ConnectionFile->Protocol->LstransFunc.LstransQueryInformation) {
		return STATUS_NOT_IMPLEMENTED;
	}

	return ConnectionFile->Protocol->LstransFunc.LstransQueryInformation( // call to LpxTdiQueryInformation_LSTrans
					ConnectionFile->ConnectionFileObject,
					QueryType,
					Buffer,
					BufferLen
