	...
	)
{
	...
	NDAS_BUGON( NdasFcStatistics->TotalThroughput.QuadPart > 0 );
	...
	)
{
	...
	if (((EndTime.QuadPart - StartTime.QuadPart) << NDAS_FC_LOG_OF_AMPLIFIER) > ((UINT64)TotalSend * NdasFcStatistics->MinimumRoundTripTime.QuadPart)) {
