	...
	case LurPrimaryLurnInformation:
		{
			...
			if(IdeDev) {
				...
				LurnInfo->NdasBindingAddress.AddressLength = Lurn->LurnDesc->LurnIde.BindingAddress.Address[0].AddressLength;
				LurnInfo->NdasBindingAddress.AddressType   = Lurn->LurnDesc->LurnIde.BindingAddress.Address[0].AddressType;
					
				RtlCopyMemory( LurnInfo->NdasBindingAddress.Address, 
							   &Lurn->LurnDesc->LurnIde.BindingAddress.Address[0].Address, 
							   Lurn->LurnDesc->LurnIde.BindingAddress.Address[0].AddressLength );
	
				LurnInfo->NdasNetDiskAddress.AddressLength = Lurn->LurnDesc->LurnIde.TargetAddress.Address[0].AddressLength;
				LurnInfo->NdasNetDiskAddress.AddressType   = Lurn->LurnDesc->LurnIde.TargetAddress.Address[0].AddressType;
					
				RtlCopyMemory( LurnInfo->NdasNetDiskAddress.Address, 
							   &Lurn->LurnDesc->LurnIde.TargetAddress.Address[0].Address, 
							   Lurn->LurnDesc->LurnIde.TargetAddress.Address[0].AddressLength );
	...
	) 
{
	...
	if (IdeDev) {
		...
		NDAS_BUGON( IdeDev->PrimaryLanScsiSession.LanscsiProtocol == NULL );
		NDAS_BUGON( IdeDev->CommLanScsiSession.LanscsiProtocol == NULL );
