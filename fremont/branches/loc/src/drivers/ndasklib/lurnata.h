...
typedef struct _BUFFLOCK_CONTROL {
	...
	BOOLEAN			BufferLockSmartControl;

} BUFFLOCK_CONTROL, *PBUFFLOCK_CONTROL;

#if 0
// Duplicated MAX_RECONNECTION_INTERVAL in lslur.h
#define IDE_DISK_DEFALUT_RECONNECT_INTERVAL		(10*NANO100_PER_SEC)
#endif
#define IDE_DISK_DEFAULT_MAX_STALL_INTERVAL(MAX_TRIAL, RECON_INTERNAL)		((MAX_TRIAL) * (RECON_INTERNAL))
