...
#define NDAS_BUGON_INSUFFICIENT_RESOURCES	FALSE
#define NDAS_BUGON_NETWORK_FAIL			FALSE
#define NDAS_BUGON_NODE_UNRECHABLE			FALSE
#define NDAS_BUGON_PAKCET_TEST				FALSE

#else

#define NDAS_BUGON_INSUFFICIENT_RESOURCES	TRUE
#define NDAS_BUGON_NETWORK_FAIL				TRUE
#define NDAS_BUGON_NODE_UNRECHABLE			TRUE
#define NDAS_BUGON_PAKCET_TEST				TRUE
