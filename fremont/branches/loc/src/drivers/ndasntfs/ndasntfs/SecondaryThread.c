   ...
   )
{
	...
	do { // just for structural programing
		...
		ndfsRequestSetup->NetdiskPort2 = Secondary->VolDo->NetdiskPartitionInformation.NetdiskInformation.NetdiskAddress.Port;
	...
	)
{
	...
	NDAS_BUGON( NTOHL(ndfsReplyHeader->MessageSize4) <= SecondaryRequest->NdfsMessageAllocationSize );
