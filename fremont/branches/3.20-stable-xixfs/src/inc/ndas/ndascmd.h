...
#pragma warning(disable: 4200)
	struct REPLY 
	{
		...
		{
			DWORD nUnitDeviceEntries;
			BYTE Reserved2[8]; // sjcho: UnitDeviceEntries is on 8n+4 boundary. 
		};
		UNITDEVICE_ENTRY UnitDeviceEntries[];
	};
#pragma warning(default: 4200)
...
C_ASSERT( (ULONGLONG)(&((NDAS_CMD_QUERY_LOGICALDEVICE_INFORMATION_V2::REPLY*)NULL)->UnitDeviceEntries) %8 ==0);
...
struct NDAS_CMD_QUERY_NDAS_LOCATION 
{
    enum { CMD = NDAS_CMD_TYPE_QUERY_NDAS_LOCATION };
    struct REQUEST 
    {
        NDAS_LOGICALDEVICE_ID LogicalDeviceId;
    };
...
//////////////////////////////////////////////////////////////////////////
//
// NDAS_CMD_QUERY_NDAS_LOGICALDEVICE_ID
//
//////////////////////////////////////////////////////////////////////////

struct NDAS_CMD_QUERY_NDAS_LOGICALDEVICE_ID
{
	enum { CMD = NDAS_CMD_TYPE_QUERY_NDAS_LOGICALDEVICE_ID };
	struct REQUEST 
	{
		NDAS_LOCATION NdasLocation;
	};
