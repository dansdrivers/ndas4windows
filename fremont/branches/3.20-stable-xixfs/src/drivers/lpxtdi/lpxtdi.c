...
LpxTdiTimerDpcRoutine(
	...
	if(irp) {
		//
		// Windows IO system does not guarantee that IRP-cancel is
		// always successful. Therefore, LPX driver must guarantee
		// the IRP will be completed within acceptable time.
		// Otherwise, we need more reliable method to stop the IRP or
