...
#define ADAPTER_STATUSFLAG_POWERRECYCLED		0x00008000
#define ADAPTER_STATUSFLAG_RAID_FAILURE			0x00010000
#define ADAPTER_STATUSFLAG_RAID_NORMAL			0x00020000
#define ADAPTER_STATUSFLAG_RESETSTATUS			0x01000000	// only used for NDASBUS notification
#define ADAPTER_STATUSFLAG_NEXT_EVENT_EXIST		0x02000000	// only used for NDASSVC notification
