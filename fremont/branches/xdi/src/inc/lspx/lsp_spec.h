...
typedef struct _lsp_ide_register_param_t {
	...
	lsp_uint8_t use_dma : 1; /*  1 : DMA, 0 : PIO */
	lsp_uint8_t use_lba : 1;
	lsp_uint8_t use_lba48  : 1; /*  1 : LBA48, 0 : use LBA28*/
	lsp_uint8_t use_type_k : 1; /* Used by packet command (kSCSICmd_SEND_KEY) at the moment */
...
LSP_C_ASSERT_SIZEOF(lsp_ide_register_param_t, 1 + 2 + 5 + 5);
