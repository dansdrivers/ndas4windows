...
#define __NDAS_MINI_PORT__				1
#define __NDAS_MINI_PORT_AVOID_ASSERT__	1
#define __NDAS_MINI_PORT_W2K_SUPPORT__	1

#define __NDAS_SCSI_OLD_VERSION__		0

#define SCSIDBG_ENABLED			1
#define USE_RTL_BITMAP			1
#define DISABLE_ADAPTER_POWER	0
//#define FORWARD_PROGRESS		0
...
#if WINVER >= 0x0501
#define NdasMiniDbgBreakPoint()	(KD_DEBUGGER_ENABLED ? DbgBreakPoint() : TRUE)
#else
#define NdasMiniDbgBreakPoint()	((*KdDebuggerEnabled) ? DbgBreakPoint() : TRUE) 
#endif

#if DBG

#define NDASMINI_ASSERT( exp )	ASSERT( exp )

#else

#define NDASMINI_ASSERT( exp )	\
	((!(exp)) ?					\
	NdasMiniDbgBreakPoint() :	\
	TRUE)
...
extern struct SP_GUID_INTERFACE_MAPPING *SpGuidInterfaceMappingList;
...
extern KEREMOVEBYKEYDEVICEQUEUEIFBUSY	NdasScsiKeRemoveByKeyDeviceQueueIfBusy;
...
extern MMPROTECTMDLSYSTEMADDRESS	NdasScsiMmProtectMdlSystemAddress;
...
extern IOFREEERRORLOGENTRY	NdasScsiIoFreeErrorLogEntry;
...
extern DBGPRINGEX	NdasScsiDbgPrintEx;
...
extern VDBGPRINTEXWITHPREFIX	NdasScsivDbgPrintExWithPrefix;


extern ULONG NdasScsiOsMajorVersion;
extern ULONG NdasScsiOsMinorVersion;
...
#define IS_WINDOWSXP_OR_LATER() \
    (((NdasScsiOsMajorVersion == 5) && (NdasScsiOsMinorVersion >= 1)) || \
     (NdasScsiOsMajorVersion > 5))

#define IS_VISTA_OR_LATER() \
    (NdasScsiOsMajorVersion >= 6)

#define IS_WINDOWS2K() \
	((NdasScsiOsMajorVersion == 5) && (NdasScsiOsMinorVersion == 0))

#define IS_WINDOWSXP() \
	((NdasScsiOsMajorVersion == 5) && (NdasScsiOsMinorVersion == 1))

#define IS_WINDOWSNET() \
	((NdasScsiOsMajorVersion == 5) && (NdasScsiOsMinorVersion == 2))

#define IS_WINDOWSVISTA() \
	((NdasScsiOsMajorVersion == 6) && (NdasScsiOsMinorVersion == 0))
