...
typedef NTSTATUS (*LSPROTO_SENDREQUEST)(PLANSCSI_SESSION LSS, PLANSCSI_PDU_POINTERS Pdu, PLSTRANS_OVERLAPPED OverlappedData, ULONG Reserved, PLARGE_INTEGER Timeout);
#else
typedef NTSTATUS 
(*LSPROTO_SENDREQUEST)( 
...
typedef struct _LSPROTO_FUNC {
	...
	LSPROTO_REQUEST			LspRequest;
	LSPROTO_REQUEST_ATAPI	LspRequestATAPI;
