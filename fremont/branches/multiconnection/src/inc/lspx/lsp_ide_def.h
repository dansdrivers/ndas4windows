...
typedef enum _lsp_ide_cmd_t {
    /* ND F N C0h */ LSP_IDE_CMD_CFA_ERASE_SECTORS = 0xC0,
    /* ND O N 03h */ LSP_IDE_CMD_CFA_REQUEST_EXTENDED_ERROR_CODE = 0x03,
    /* PI O N 87h */ LSP_IDE_CMD_CFA_TRANSLATE_SECTOR = 0x87,
    /* PO O N CDh */ LSP_IDE_CMD_CFA_WRITE_MULTIPLE_WITHOUT_ERASE = 0xCD,
    /* PO O N 38h */ LSP_IDE_CMD_CFA_WRITE_SECTORS_WITHOUT_ERASE = 0x38,
    /* ND O N D1h */ LSP_IDE_CMD_CHECK_MEDIA_TYPE_CARD = 0xD1,
    /* */ LSP_IDE_CMD_CHECK_POWER_MODE = 0xE5,
    /* */ LSP_IDE_CMD_CONFIGURE_STREAM = 0x51,
    /* */ LSP_IDE_CMD_DEVICE_CONFIGURATION = 0xB1,
    /* */ LSP_IDE_CMD_DEVICE_RESET = 0x08,
    /* */ LSP_IDE_CMD_DEVICE_DOWNLOAD_MICROCODE = 0x92,
    /* */ LSP_IDE_CMD_EXECUTE_DEVICE_DIAGNOSTIC = 0x90,
    /* */ LSP_IDE_CMD_FLUSH_CACHE = 0xE7,
    /* */ LSP_IDE_CMD_FLUSH_CACHE_EXT = 0xEA,
    /* */ LSP_IDE_CMD_GET_MEDIA_STATUS = 0xDA,
    /* */ LSP_IDE_CMD_IDENTIFY_DEVICE = 0xEC,
    /* */ LSP_IDE_CMD_IDENTIFY_PACKET_DEVICE = 0xA1,
    /* */ LSP_IDE_CMD_IDLE = 0xE3,
    /* */ LSP_IDE_CMD_IDLE_IMMEDIATE = 0xE1,
    /* */ LSP_IDE_CMD_MEDIA_EJECT = 0xED,
    /* */ LSP_IDE_CMD_MEDIA_LOCK = 0xDE,
    /* */ LSP_IDE_CMD_MEDIA_UNLOCK = 0xDF,
    /* */ LSP_IDE_CMD_NOP = 0x00,
    LSP_IDE_CMD_PACKET = 0xA0,
    LSP_IDE_CMD_READ_BUFFER = 0xE4,
    LSP_IDE_CMD_READ_DMA = 0xC8,
    LSP_IDE_CMD_READ_DMA_EXT = 0x25,
    LSP_IDE_CMD_READ_DMA_QUEUED = 0xC7,
    LSP_IDE_CMD_READ_DMA_QUEUED_EXT = 0x26,
    LSP_IDE_CMD_READ_LOG_EXT = 0x2F,
    LSP_IDE_CMD_READ_MULTIPLE = 0xC4,
    LSP_IDE_CMD_READ_MULTIPLE_EXT = 0x29,
    LSP_IDE_CMD_READ_NATIVE_MAX_ADDRESS = 0xF8,
    LSP_IDE_CMD_READ_NATIVE_MAX_ADDRESS_EXT = 0x27,
    LSP_IDE_CMD_READ_SECTORS = 0x20,
    LSP_IDE_CMD_READ_SECTORS_EXT = 0x24,
    LSP_IDE_CMD_READ_STREAM_DMA_EXT = 0x2A,
    LSP_IDE_CMD_READ_STREAM_EXT = 0x2B,
    LSP_IDE_CMD_READ_VERIFY_SECTORS = 0x40,
    LSP_IDE_CMD_READ_VERIFY_SECTORS_EXT = 0x42,
    LSP_IDE_CMD_SECURITY_DISABLE_PASSWORD = 0xF6,
    LSP_IDE_CMD_SECURITY_ERASE_PREPARE = 0xF3,
    LSP_IDE_CMD_SECURITY_ERASE_UNIT = 0xF4,
    LSP_IDE_CMD_SECURITY_FREEZE_LOCK = 0xF5,
    LSP_IDE_CMD_SECURITY_SET_PASSWORD = 0xF1,
    LSP_IDE_CMD_SECURITY_UNLOCK = 0xF2,
    LSP_IDE_CMD_SERVICE = 0xA2,
    LSP_IDE_CMD_SET_FEATURES = 0xEF,
    LSP_IDE_CMD_SET_MAX = 0xF9,
    LSP_IDE_CMD_SET_MAX_ADDRESS_EXT = 0x37,
    LSP_IDE_CMD_SET_MULTIPLE_MODE = 0xC6,
    LSP_IDE_CMD_SLEEP = 0xE6,
    LSP_IDE_CMD_SMART = 0xB0,
    LSP_IDE_CMD_STANDBY = 0xE2,
    LSP_IDE_CMD_STANDBY_IMMEDIATE = 0xE0,
    LSP_IDE_CMD_WRITE_BUFFER = 0xE8,
    LSP_IDE_CMD_WRITE_DMA = 0xCA,
    LSP_IDE_CMD_WRITE_DMA_EXT = 0x35,
    LSP_IDE_CMD_WRITE_DMA_FUA_EXT = 0x3D,
    LSP_IDE_CMD_WRITE_DMA_QUEUED = 0xCC,
    LSP_IDE_CMD_WRITE_DMA_QUEUED_EXT = 0x36,
    LSP_IDE_CMD_WRITE_DMA_QUEUED_FUA_EXT = 0x3E,
    LSP_IDE_CMD_WRITE_LOG_EXT = 0x3F,
    LSP_IDE_CMD_WRITE_MULTIPLE = 0xC5,
    LSP_IDE_CMD_WRITE_MULTIPLE_EXT = 0x39,
    LSP_IDE_CMD_WRITE_MULTIPLE_FUA_EXT = 0xCE,
    LSP_IDE_CMD_WRITE_SECTORS = 0x30,
    LSP_IDE_CMD_WRITE_SECTORS_EXT = 0x34,
    LSP_IDE_CMD_WRITE_STREAM_DMA_EXT = 0x3A,
    LSP_IDE_CMD_WRITE_STREAM_EXT = 0x3B
} lsp_ide_cmd_t;
...
} lsp_ide_identify_packet_device_data_t;
