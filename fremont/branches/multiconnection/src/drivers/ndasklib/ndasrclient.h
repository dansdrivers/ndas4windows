...
#define NDASR_CLIENT_STATUS_EASTBLISH_ARBITER_MODE	0x00001000
#define NDASR_CLIENT_STATUS_ARBITER_MODE			0x00002000 
#define NDASR_CLIENT_STATUS_NON_ARBITER_MODE1		0x00004000

#define NDASR_CLIENT_STATUS_ARBITER_CONNECTED		0x00010000 
#define NDASR_CLIENT_STATUS_ARBITER_DISCONNECTED	0x00020000 
...
typedef struct _NDASR_CLIENT {
	...
	UCHAR				NdasrNodeFlags[MAX_NDASR_MEMBER_DISK];	
	UCHAR				NdasrDefectCodes[MAX_NDASR_MEMBER_DISK]; 

	UCHAR				RoleToNodeMap[MAX_NDASR_MEMBER_DISK];	
	...
	PCHAR				BlockBuffer[MAX_NDASR_MEMBER_DISK];
	UCHAR				Buffer[0];
