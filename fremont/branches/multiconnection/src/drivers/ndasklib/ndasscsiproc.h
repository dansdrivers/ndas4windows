...
#define __NDAS_SCSI_LPXTDI_V2__			1
#define __NDAS_SCSI_RESET_ALLOW_MODE__	1

#define __NDAS_SCSI_NEW_LURN_IDE_DISK__	1
...
#define NDASSCSI_ASSERT_NETWORK_FAIL			TRUE
