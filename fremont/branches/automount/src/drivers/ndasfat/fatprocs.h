...
FINISHED
FatAcquireExclusiveSecondaryVcb_Real (
    IN PIRP_CONTEXT IrpContext,
    IN PVCB Vcb,
    IN BOOLEAN NoOpCheck
    );

#define FatAcquireExclusiveSecondaryVcb( IC, V)          FatAcquireExclusiveSecondaryVcb_Real( IC, V, FALSE)
#define FatAcquireExclusiveSecondaryVcbNoOpCheck( IC, V) FatAcquireExclusiveSecondaryVcb_Real( IC, V, TRUE)

FINISHED
FatAcquireSharedSecondaryVcb (
    IN PIRP_CONTEXT IrpContext,
    IN PVCB Vcb
    );
...
#define FatVcbAcquiredExclusive(IRPCONTEXT,VCB) (																				\
	(FlagOn(IRPCONTEXT->NdFatFlags, ND_FAT_IRP_CONTEXT_FLAG_SECONDARY_CONTEXT) ?												\
...
#define FatReleaseSecondaryVcb(IRPCONTEXT,Vcb) {			\
