...

{
	...
	if (OurDeviceObject->Secondary) {
		...
		case IRP_MN_QUERY_REMOVE_DEVICE: {
			...
			secondaryCreateResourceAcquired 
				= SecondaryAcquireResourceExclusiveLite( IrpContext, 
														 &OurDeviceObject->Secondary->CreateResource, 
	...
	if (secondaryCreateResourceAcquired && OurDeviceObject->Secondary) {

		SecondaryReleaseResourceLite( IrpContext, &OurDeviceObject->Secondary->CreateResource );
