...
call :run_build -WNET2K %CONF% %_BUILDP_BASE_DIR%drivers\w2kfatlib
REM call :run_build -WNET2K %CONF% %_BUILDP_BASE_DIR%drivers\w2kntfslib
call :run_build -WNETXP %CONF% %_BUILDP_BASE_DIR%drivers\wxpfatlib
REM call :run_build -WNETXP %CONF% %_BUILDP_BASE_DIR%drivers\wxpntfslib
call :run_build -WNET   %CONF% %_BUILDP_BASE_DIR%drivers\wnetfatlib
...
call :run_build -WNET AMD64 %CONF% %_BUILDP_BASE_DIR%drivers\wnetfatlib
