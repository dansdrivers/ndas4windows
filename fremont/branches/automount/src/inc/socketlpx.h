...
#define		LPXRP_LFS_PRIMARY			((USHORT)0x0001)	// stream
#define		LPXRP_LFS_CALLBACK			((USHORT)0x0002)	// stream
#define		LPXRP_LFS_DATAGRAM			((USHORT)0x0003)	// datagram
#define		LPXRP_LSHELPER_INFOEX		((USHORT)0x0011)	// datagram
#define		LPXRP_NDAS_PROTOCOL			((USHORT)0x2710)	// stream
#define		LPXRP_NDAS_HEARTBEAT_SRC	((USHORT)0x2711)	// datagram
#define		LPXRP_NDAS_HEARTBEAT_DEST	((USHORT)0x2712)	// datagram
