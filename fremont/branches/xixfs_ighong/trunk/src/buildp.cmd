...
call :run_build -WNET2K %CONF% %_BUILDP_BASE_DIR%drivers\w2kntfslib
call :run_build -WNETXP %CONF% %_BUILDP_BASE_DIR%drivers\wxpfatlib
call :run_build -WNETXP %CONF% %_BUILDP_BASE_DIR%drivers\wxpntfslib
...
REM call :run_build -WNET AMD64 %CONF% %_BUILDP_BASE_DIR%drivers\ndasntfs
	)
	if defined BUILDP_DIR (
