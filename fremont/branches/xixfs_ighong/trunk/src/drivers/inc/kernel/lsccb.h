...
#define CCB_OPCODE_XIFS_LOCK_GB			(CCB_OPCODE_CONTROL_BIT|0x9)
#define CCB_OPCODE_XIFS_UNLOCK_GB		(CCB_OPCODE_CONTROL_BIT|0xa)
#define CCB_OPCODE_XIFS_QUERY_LOCK_GB	(CCB_OPCODE_CONTROL_BIT|0xb)
