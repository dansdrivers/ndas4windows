...
#define FatVcbAcquiredExclusive(IRPCONTEXT,VCB) (																				\
	((IRPCONTEXT && FlagOn(IRPCONTEXT->NdFatFlags, ND_FAT_IRP_CONTEXT_FLAG_SECONDARY_FILE)) ?									\
...
#define FatReleaseVcb(IRPCONTEXT,Vcb) {					\
	PERESOURCE	resource;								\
	resource = (IRPCONTEXT && FlagOn((IRPCONTEXT)->NdFatFlags, ND_FAT_IRP_CONTEXT_FLAG_SECONDARY_FILE)) ? &Vcb->SecondaryResource : &Vcb->Resource; \
