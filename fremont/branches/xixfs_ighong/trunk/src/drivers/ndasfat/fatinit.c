...

{
...
#if DBG
	DbgPrint( "NdFat DriverEntry %s %s\n", __DATE__, __TIME__ );
#endif
    ...
    RtlInitUnicodeString( &UnicodeString, ND_FAT_CONTROL_DEVICE_NAME );
    ...
    RtlInitUnicodeString( &linkString, ND_FAT_CONTROL_LINK_NAME );
    ...
    RtlInitUnicodeString( &UnicodeString, ND_FAT_DEVICE_NAME );
    ...
    RtlInitUnicodeString( &UnicodeString, L"\\NdFatCdrom" );
