                    ...
                    if (FlagOn(Fcb->FcbState, FCB_STATE_DELETE_ON_CLOSE) &&
						...
						if (FlagOn(CONTAINING_RECORD(Vcb, VOLUME_DEVICE_OBJECT, Vcb)->NdasFatFlags, ND_FAT_DEVICE_FLAG_DIRECT_RW)   &&
							...
							if (IrpContext->PrimaryRequestInfo.NdfsWinxpRequestHeader == NULL ) {
								...
								NDAS_ASSERT( IrpContext->PrimaryRequestInfo.NdfsWinxpRequestHeader->CleanUp.FileSize );   

								NDAS_ASSERT( Fcb->Header.FileSize.LowPart == IrpContext->PrimaryRequestInfo.NdfsWinxpRequestHeader->CleanUp.FileSize );
								NDAS_ASSERT( Fcb->Header.AllocationSize.QuadPart == IrpContext->PrimaryRequestInfo.NdfsWinxpRequestHeader->CleanUp.AllocationSize );
