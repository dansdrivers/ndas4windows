...
#define NMT_RAID0R2			9		// Block size is 512B not 512 * n. RMD is used.
...
#define NMT_RAID4R3			13		// with DRAID & persistent OOS bitmap. Added as of 3.21. Not implemented yet.
#define NMT_RAID5			14		// with DRAID & persistent OOS bitmap. Added as of 3.21. Not implemented yet.
#define NMT_SAFE_AGGREGATE	15		// operation purpose only(append disk to single disk) : must NOT written on disk. used in bind operation only
...
#define NDAS_UNIT_META_BIND_STATUS_OFFLINE				(1<<5)
