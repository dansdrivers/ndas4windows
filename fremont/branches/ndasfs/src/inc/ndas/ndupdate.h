...
typedef struct _NDUPDATE_UPDATE_INFO_V2 {
	BOOL fNeedUpdate;
	struct {
		WORD wMajor;
		WORD wMinor;
	...
	DWORD dwFullSetupFileSize;
	TCHAR szFullSetupFileName[MAX_PATH];
	TCHAR szFullSetupFileURL[NDUPDATE_MAX_URL];
	TCHAR szRefURL[NDUPDATE_MAX_URL];
	DWORD dwSmallSetupFileSize;
	TCHAR szSmallSetupFileName[MAX_PATH];
	TCHAR szSmallSetupFileURL[NDUPDATE_MAX_URL];
    DWORD dwPatchFileSize;
	TCHAR szPatchFileName[MAX_PATH];
    TCHAR szPatchFileURL[NDUPDATE_MAX_URL];
} NDUPDATE_UPDATE_INFO_V2, *PNDUPDATE_UPDATE_INFO_V2;
