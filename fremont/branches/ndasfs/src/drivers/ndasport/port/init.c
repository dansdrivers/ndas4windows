...
PVOID NdasPortDriverExtensionTag = DriverEntry;
PDRIVER_OBJECT NdasPortDriverObject = NULL;

BOOLEAN NdasPortIsWindowsXPOrLater;

volatile ULONG __DisableDriverLoad = 0;
volatile ULONG __DisablePersistentLogicalUnits = 0;
	...
	__in PUNICODE_STRING RegistryPath)
{
	...
	NdasPortIsWindowsXPOrLater = IoIsWdmVersionAvailable(0x01, 0x20);
