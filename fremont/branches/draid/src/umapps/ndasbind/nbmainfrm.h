...
//		UPDATE_ELEMENT(IDM_TOOL_SPAREREMOVE, UPDUI_MENUPOPUP | UPDUI_TOOLBAR )
		UPDATE_ELEMENT(IDM_TOOL_RESET_TYPE, UPDUI_MENUPOPUP | UPDUI_TOOLBAR )
...
//		COMMAND_ID_HANDLER_EX(IDM_TOOL_SPAREREMOVE, OnSpareRemove)
		...
		COMMAND_ID_HANDLER_EX(IDM_TOOL_RESET_TYPE, OnResetType)
	...
	void OnResetType(UINT wNotifyCode, int wID, HWND hwndCtl);
