...
CNdasEventMonitor::OnLogicalDeviceAlarmed(CNdasLogicalDevicePtr pLogDevice)
{
	...
	XTLTRACE2(NDASSVC_EVENTMON, TRACE_LEVEL_INFORMATION,
		"Alarm Event from %s: %s\n", 
		ndasScsiLocation.ToStringA(), pLogDevice->ToStringA());
	...
	{
		XTLTRACE2(NDASSVC_EVENTMON, TRACE_LEVEL_ERROR,
			"(%s) query status failed on alarm, ignored\n", 
			ndasScsiLocation.ToStringA());
		return;
	}

	XTLTRACE2(NDASSVC_EVENTMON, TRACE_LEVEL_INFORMATION,
		"(%s) alarmed %08X.\n", ndasScsiLocation.ToStringA(), ulAdapterStatus);
...
CNdasEventMonitor::OnLogicalDeviceDisconnected(CNdasLogicalDevicePtr pLogDevice)
{
	...
	XTLTRACE2(NDASSVC_EVENTMON, TRACE_LEVEL_ERROR,
		"Disconnect Event from %s: %s\n", 
		location.ToStringA(), pLogDevice->ToStringA());
