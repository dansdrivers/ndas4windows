...
#define DRVO_BASE_FILESYSTEM_DRIVER	0x00000080   // A driver that is at the bottom of the filesystem stack.
	...
	if ((PVOID)FatControlDeviceObject == VolumeDeviceObject) {
		...
		if (irpSp->Parameters.FileSystemControl.FsControlCode == NDAS_FS_UNLOAD) {
			...
			DebugTrace2( 0, Dbg2, ("IoControlCode != NDAS_FS_UNLOAD\n", 0) );
...
#ifdef __NDAS_FAT_LINKSYS_SUPPORT__
...
if (IS_WINDOWS2K()) {
				...
				DebugTrace2( 0, Dbg2, ("netdiskEnableMode = %d, VolDo->NetdiskPartitionInformation.PartitionInformation.PartitionNumber = %d\n", 
										netdiskEnableMode, VolDo->NetdiskPartitionInformation.PartitionInformation.PartitionNumber) );

} else {

				DebugTrace2( 0, Dbg2, ("netdiskEnableMode = %d, VolDo->NetdiskPartitionInformation.PartitionInformationEx.PartitionNumber = %d\n", 
...
#if __NDAS_FAT_LINKSYS_SUPPORT__
