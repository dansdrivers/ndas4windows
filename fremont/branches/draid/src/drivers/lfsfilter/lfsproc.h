...
#define __ENABLE_DEAD_LOCKVOLUME_PREVENTION__	1

#define __LFS_FLUSH_VOLUME__					0

#define __LFS_NDAS_NTFS__						0
#define __LFS_NDAS_FAT__						0
...
#define LFS_TIME_OUT					(HZ * 1200)  // This timeout should not happen. Because of possible delay in ConnectToPrimary, set to at least over 120 sec
