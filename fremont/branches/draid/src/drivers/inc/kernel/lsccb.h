...
#define CCBSTATUS_FLAG_LURN_DEGRADED	0x00000020	// Member of fault-tolerant RAID is stopped.
#define CCBSTATUS_FLAG_RECOVERING			0x00000040
#define CCBSTATUS_FLAG_LONG_COMM_TIMEOUT	0x00000080
#define CCBSTATUS_FLAG_DEFECTIVE		0x00000200 // Disk is defective. Advise to use bindtool to solve the problem
							// Not yet used for notitying user.
