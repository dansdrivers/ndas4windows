...
#define LSP_HW_VERSION_MAX			LSP_HW_VERSION_2_0 // frame.vhd : cVERSION_MAX

// hardware revision

#define LSP_HW_VER20_REV_1G_ORIGINAL	0x0000
#define LSP_HW_VER20_REV_100M			0x0018
#define LSP_HW_VER20_REV_1G				0x0010
