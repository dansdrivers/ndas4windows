...
#define __NDAS_FAT_PURGE_OR_FLUSH__	0
...
#if WINVER >= 0x0501
#define NdasFatDbgBreakPoint()	{if (KD_DEBUGGER_ENABLED) DbgBreakPoint();}
#else
#define NdasFatDbgBreakPoint()	{if (*KdDebuggerEnabled) DbgBreakPoint();}
#endif
...
FINISHED
FatAcquireExclusiveSecondaryVcb (
    IN PIRP_CONTEXT IrpContext,
    IN PVCB Vcb
    );
