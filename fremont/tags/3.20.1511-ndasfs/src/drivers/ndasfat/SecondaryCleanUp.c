...

{
    ...
    try {
        ...
        case UserFileOpen:
			...
			//DbgPrint( "c Fcb->Header.FileSize.LowPart = %x, Fcb->Header.ValidDataLength.LowPart = %x\n", 
			//		   Fcb->Header.FileSize.LowPart, Fcb->Header.ValidDataLength.LowPart );
		...
		SetFlag( Ccb->NdFatFlags, ND_FAT_CLEANUP_COMPLETE );
