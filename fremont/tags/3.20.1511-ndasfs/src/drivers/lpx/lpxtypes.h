...
#define LPX_DEFAULT_SMP_TIMER_INTERVAL			(50*MILIHZ)

#define LPX_DEFAULT_MAX_STALL_INTERVAL			(8*HZ)
#define LPX_DEFALUT_MAX_CONNECT_WAIT_INTERVAL	(2*HZ)

#define LPX_DEFAULT_RETRANSMIT_INTERVAL			(200*MILIHZ)
#define LPX_DEFAULT_ALIVE_INTERVAL				(1*HZ)

#define LPX_DEFAULT_TIME_WAIT_INTERVAL			(1*HZ)
#define LPX_DEFAULT_LAST_ACK_INTERVAL			(4*HZ)
...
typedef struct _LPX_SMP {
	...
	LARGE_INTEGER	LastDataPacketArrived;
	
	LPX_ADDRESS		DestinationAddress;		// Address of peer
	UCHAR           ServerTag;
	BOOLEAN			DestinationNonDelayedAck;
...
#define SMP_TIMER_RECEIVE_TIME_OUT	0x00000002
...
#define LPX_DEFAULT_STATSTICS_INTERVAL	(60*HZ)
...
#define LPX_DEVICE_CONTEXT_MIDIA_CONNECTED			0x00000010
#define LPX_DEVICE_CONTEXT_MIDIA_DISCONNECTED		0x00000020
