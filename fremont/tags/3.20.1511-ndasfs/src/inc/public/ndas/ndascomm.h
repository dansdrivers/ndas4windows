...
NdasCommBlockDeviceRead(
	...
	__out_bcount(SectorCount*512) PBYTE Data);
...
NdasCommBlockDeviceWrite(
	...
	__in INT64 Location,
	__in UINT64	SectorCount,
	__inout_bcount(SectorCount*512) PBYTE MutableData);
...
NdasCommGetDeviceID(
	...
	__in_opt CONST NDASCOMM_CONNECTION_INFO* ConnectionInfo,
	__out PBYTE DeviceId,
	__out LPDWORD UnitNo,
	__out_opt LPBYTE VID);
...
NdasCommBlockDeviceLockedWrite(
	...
	__in INT64 Location,
	__in UINT64	SectorCount,
	__inout_bcount(SectorCount*512) PBYTE Data);
...
NdasCommBlockDeviceLockedWriteSafeBuffer(
	...
	__in INT64 Location,
	__in UINT64 SectorCount,
	__in_bcount(SectorCount*512) CONST BYTE* Data);
