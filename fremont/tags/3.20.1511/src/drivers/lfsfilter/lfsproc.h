...
#define __LFS__									1
#define __LFS_ALLOW_UNLOAD_DRIVER__				1

#if DBG

#define __NDAS_NTFS_x32_RW__					0
#define __NDAS_NTFS_x32_RO__					0

#define __NDAS_NTFS_x64_RW__					0
#define __NDAS_NTFS_x64_RO__					0

#define __NDAS_FAT_RW__							0
#define __NDAS_FAT_RO__							0

#define __LFS_READONLY_PURGE_VERSION__			0
...
#define __LFS_FLUSH_VOLUME__					0

#define __LFS_ENUMERATION__						0
#define __ENABLE_DEAD_LOCKVOLUME_PREVENTION__	0


#define	__LFS_NDSC_ID__							1
...
#define LFS_CHANGECONNECTION_TIMEOUT	(HZ * 60) // ((RECONNECTION_MAX_TRY * MAX_RECONNECTION_INTERVAL) * 2)
...
#define LFS_READONLY_THREAD_FLAG_TIME_OUT	(20 * HZ)
...
#if WINVER >= 0x0501
#define LfsDbgBreakPoint()	{if (KD_DEBUGGER_ENABLED) DbgBreakPoint();} 
#else
#define LfsDbgBreakPoint()	{if (*KdDebuggerEnabled) DbgBreakPoint();}
#endif
