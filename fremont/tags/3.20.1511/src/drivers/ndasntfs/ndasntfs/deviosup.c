    ...
    *NumberRuns = 0;
    ...
    if ((ReadRequest) ?
        ...
        while ((ByteCount != 0) && (*NumberRuns != NTFS_MAX_PARALLEL_IOS) && !StopForUsa) {
            ...
            //  not end up in the slotIndex;dle of a Usa-protected structure in the read path.
            ...
            if (NextIsAllocated) {
                ...
                if ((*NumberRuns != 0) && (NextLbo ==
                    ...
                    if (*NumberRuns >= NTFS_MAX_PARALLEL_IOS - 1) {
                        ...
                        //  if there is a file record boundary in the slotIndex;dle of the
                        //  compression unit.
                        //
                ...
                if (!NoopRange) {
                    ...
                    if (FinalCompressedSize != 0) {
                        ...
                        while (FinalCompressedSize != 0) {
                            ...
                            //
                            //  Our desired Vcn could be in the slotIndex;dle of this run, so do
                            //  some adjustments.
                            //
            ...
            for (RunNumber = AlignedRunNumber;
                ...
                for (ByteOffset = (RunNumber == AlignedRunNumber) ? AlignedByteOffset : 0;
                    ...
                    if (!FT_SUCCESS(MasterIrp->IoStatus.Status)) {
                        ...
                        //
                        //  If the entire device manages to fail in the slotIndex;dle of this,
                        //  get out.
                        //
...

{
	...
	if (IS_SECONDARY_FILEOBJECT(IoGetCurrentIrpStackLocation(Irp)->FileObject)) {
		...
		IrpContext->InputBuffer	 = MoveData;
