...
#define Dbg2                             (DEBUG_INFO_ATTRSUP)
#endif
...
*/                
        ...
        if (((Scb->ScbSnapshot != NULL) &&
            ...
            if ((AdvanceOnly
				...
				DebugTrace( 0, Dbg, ("ValidLength Updated\n") );
    ...
    while (TRUE) {
        ...
        try {
...

            {
                ...
                //  the current file record, as we may wish to split in the slotIndex;dle
                ...
                if (LastVcn < NewHighestVcn) {
                    ...
                    if (ARGUMENT_PRESENT( StartingVcn ) &&
                        ...
                        //  an overwrite somewhere in the slotIndex;dle of the file.  To avoid
                        //  shoving a couple mapping pairs off the end over and over, we
                        //  will arbitrarily split this attribute in the slotIndex;dle.  We do
                        //  so by looking up the lowest and highest Vcns that we are working
                        //  with and get their indices, then split in the slotIndex;dle.
                        //
                            ...
                            //
                            //  Calculate the index in the slotIndex;dle.
                            //
                            ...
                            //
                            //  Lookup the slotIndex;dle run and use the Last Vcn in that run.
                            //
...
Routine Description:
    ...
    Essentially this routine finds the slotIndex;point in the current file record
