...
#define NDFAT_TRY_FLUSH_OR_PURGE_DURATION		NDFAT_VOLDO_THREAD_FLAG_TIME_OUT
...
#define FSCTL_ND_FAT_FLUSH_OR_PURGE				CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 0x3FDA, METHOD_BUFFERED, FILE_READ_ACCESS)
...
typedef
VOID (*NDFAT_CC_MDL_WRITE_ABORT) ( IN PFILE_OBJECT FileObject, IN PMDL MdlChain );

extern NDFAT_CC_MDL_WRITE_ABORT NdFatCcMdlWriteAbort;