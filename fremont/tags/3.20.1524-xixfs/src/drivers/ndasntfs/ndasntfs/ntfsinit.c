...

{
...
#if DBG
	DbgPrint("NdasNtfs DriverEntry %s %s\n", __DATE__, __TIME__);
#endif
	...
	NdasNtfsSeFilterToken = MmGetSystemRoutineAddress( &functionName );
	...
	NdasNtfsKeAreApcsDisabled = MmGetSystemRoutineAddress( &functionName );
...
#if DBG
	DbgPrint("NdasNtfs NdasNtfsUnload %s %s\n", __DATE__, __TIME__);
#endif
