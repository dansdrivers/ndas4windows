...
#ifdef ALLOC_PRAGMA
#pragma alloc_text(PAGE, xixfs_RawDevIoCtrl)
#pragma alloc_text(PAGE, xixfs_RawWriteBlockDevice)
#pragma alloc_text(PAGE, xixfs_RawReadBlockDevice)
#endif
	...
	)
{
	...
	//PAGED_CODE();
	DebugTrace(DEBUG_LEVEL_TRACE, (DEBUG_TARGET_DEVCTL|DEBUG_TARGET_FCB|DEBUG_TARGET_VCB),
		("Enter xixfs_RawWriteBlockDevice \n"));
	...
	DebugTrace(DEBUG_LEVEL_TRACE, (DEBUG_TARGET_DEVCTL|DEBUG_TARGET_FCB|DEBUG_TARGET_VCB),
		("Exit xixfs_RawWriteBlockDevice \n"));
	...
	)
{
	...
	//PAGED_CODE();
	DebugTrace(DEBUG_LEVEL_TRACE, (DEBUG_TARGET_DEVCTL|DEBUG_TARGET_FCB|DEBUG_TARGET_VCB),
		("Enter xixfs_RawReadBlockDevice \n"));
	...
	)
{
	...
	NewOffset.QuadPart = SECTOR_ALIGNED_ADDR(SectorSizeBit, Offset->QuadPart);
	NewLength = (uint32) SECTOR_ALIGNED_SIZE(SectorSizeBit, Length);
