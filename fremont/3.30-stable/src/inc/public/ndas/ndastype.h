...
typedef enum _NDAS_DEVICE_STATUS {
	...
	NDAS_DEVICE_STATUS_DISABLED     = 0x0010,
	NDAS_DEVICE_STATUS_OFFLINE      = 0x0020,
	NDAS_DEVICE_STATUS_ONLINE       = 0x0030,
	NDAS_DEVICE_STATUS_CONNECTING   = 0x0040,
	NDAS_DEVICE_STATUS_NOT_REGISTERED = 0x0050,
};

#define NDAS_DEVICE_STATUS_DISCONNECTED NDAS_DEVICE_STATUS_OFFLINE
#define NDAS_DEVICE_STATUS_CONNECTED NDAS_DEVICE_STATUS_ONLINE
