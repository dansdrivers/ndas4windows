...
typedef struct _NDAS_LOGICALUNIT_DEFINITION {
	...
	DWORD NdasUnitCount; // DIB_V2.nDiskCount + DIB_V2.nSpareCount
	DWORD SpareNdasUnitCount; // nUnitDevicesInRaid = nUnitDevices - nUnitDevicesSpare
	BOOL NotLockable;
	UINT64 StartOffset;
	NDAS_UNITDEVICE_ID NdasUnits[MAX_NDAS_LOGICALDEVICE_GROUP_MEMBER];
	BOOL ActiveNdasUnits[MAX_NDAS_LOGICALDEVICE_GROUP_MEMBER];
...
typedef enum _NDAS_RAID_SIMPLE_STATUS_FLAG {
	...
	NDAS_RAID_SIMPLE_STATUS_BAD_DISK_IN_SPARE		= 0x10000001,
	NDAS_RAID_SIMPLE_STATUS_BAD_SECTOR_IN_REGULAR	= 0x00000002,
	NDAS_RAID_SIMPLE_STATUS_BAD_SECTOR_IN_SPARE		= 0x10000002,
	NDAS_RAID_SIMPLE_STATUS_REPLACED_IN_REGULAR		= 0x00000004,
	NDAS_RAID_SIMPLE_STATUS_REPLACED_IN_SPARE		= 0x10000004,
	NDAS_RAID_SIMPLE_STATUS_NOT_SYNCED				= 0x00000010,
	NDAS_RAID_SIMPLE_STATUS_EMERGENCY				= 0x00000100,
