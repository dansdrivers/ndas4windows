...

{
    ...
    try_exit:  NOTHING;
        ...
        DebugUnwind3( FatFastUnlockSingle );
...

{
    ...
    try_exit:  NOTHING;
        ...
        DebugUnwind3( FatFastUnlockAllByKey );
...

{
	...
	if (FlagOn(Ccb->NdasFatFlags, ND_FAT_CCB_FLAG_UNOPENED)) {
		...
		DebugTrace2( -1, Dbg, ("NtfsCommonLockControl -> STATUS_FILE_CORRUPT_ERROR\n") );
