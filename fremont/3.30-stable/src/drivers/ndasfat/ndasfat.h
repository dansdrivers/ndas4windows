...
#define NDASFAT_TIME_OUT						(360000 * NANO100_PER_SEC)
#define NDASFAT_SECONDARY_THREAD_FLAG_TIME_OUT	(3 * NANO100_PER_SEC)
#define NDASFAT_TRY_CLOSE_DURATION				NDASFAT_SECONDARY_THREAD_FLAG_TIME_OUT
#define NDFAT_VOLDO_THREAD_FLAG_TIME_OUT		(3 * NANO100_PER_SEC)
#define NDFAT_TRY_FLUSH_DURATION				NDFAT_VOLDO_THREAD_FLAG_TIME_OUT
#define NDFAT_TRY_PURGE_DURATION				(30 * NANO100_PER_SEC)
#define NDASFAT_QUERY_REMOVE_TIME_OUT			(12 * NANO100_PER_SEC) 
...
#define IS_SECONDARY_FILEOBJECT( FileObject ) (																	\
	...
	(NodeType(FileObject->FsContext) == NDFAT_NTC_VCB || NodeType(FileObject->FsContext) == FAT_NTC_ROOT_DCB ||	\
	 NodeType(FileObject->FsContext) == FAT_NTC_DCB || NodeType(FileObject->FsContext) == FAT_NTC_FCB)		&&	\
