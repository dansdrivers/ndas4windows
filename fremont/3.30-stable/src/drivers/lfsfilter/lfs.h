...
typedef	struct _LFS {
	...
	BOOLEAN					NdasNtfsSupport;
	BOOLEAN					NdasRofsSupport;
	BOOLEAN					NdasFatSupport;

	BOOLEAN					NdasFsForceFiltering;
...
#define LFS_DEVICE_FLAG_FILTERING			0x00001000
