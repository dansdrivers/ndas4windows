...
extern PDEVICE_OBJECT NdasNtfsControlDeviceObject;
extern PDEVICE_OBJECT NdasNtfsFileSystemDeviceObject;
...
extern const UNICODE_STRING NdasNtfsSDH;
#endif
...
extern LONGLONG NtfsDebugTraceLevel;
extern LONG NtfsDebugTraceIndent;
extern LONG NtfsstatusFilter;
...
#define DEBUG_TRACE_ALL		             (0x0000000100000000)
#define DEBUG_INFO_ALL                   (0x0000000200000000)
#define DEBUG_INFO_OBJIDSUP				 (0x0000000200000000) // shared with Quota
...
#define DEBUG_INFO_SHUTDOWN              (0x0000040000000000) // shared with FsCtrl
...
#define DEBUG_INFO_LOGSUP                (0x0002000000000000)
#define DEBUG_INFO_ALLOCSUP				 (0x0008000000000000)
#define DEBUG_INFO_RESRCSUP				 (0x0008000000000000)

#define DEBUG_INFO_ATTRSUP               (0x0040000000000000)
...
#define DEBUG_TRACE_SECONDARY			 (0x0010000000000000)
#define DEBUG_INFO_SECONDARY             (0x0020000000000000)

#define DEBUG_TRACE_PRIMARY				 (0x0100000000000000)
#define DEBUG_INFO_PRIMARY               (0x0200000000000000)

#define DEBUG_INFO_NDNTFS                (0x2000000000000000)
