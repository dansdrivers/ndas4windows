...
#define NDASPORT_ENUMERATORW L"{56552ED5-F57A-4A9D-B13E-251A838E5D7B}"
#define NDASPORT_ENUMERATORA "{56552ED5-F57A-4A9D-B13E-251A838E5D7B}"

#ifdef UNICODE
#define NDASPORT_ENUMERATOR NDASPORT_ENUMERATORW
#else
#define NDASPORT_ENUMERATOR NDASPORT_ENUMERATORA
#endif
...
//
// Input : ULONG (must be 1)
// Output: None
// OutputBufferLength: None
//
#define IOCTL_NDASPORT_DELEGATE_LOGICALUNIT_ENTRY NDASPORT_IOCTL_RW(0x806)
