...
#define NDAS_LPX_V1			0x0000
#define NDAS_TCP			0x0001

typedef	UINT16 NDAS_TRANS_TYPE, *PNDAS_TRANS_TYPE;

#define NR_NDAS_PROTOCOL		1
#define NR_NDAS_MAX_PROTOCOL	16

extern PNDAS_TRANSPORT_INTERFACE	NdasTransportList[NR_NDAS_MAX_PROTOCOL];
