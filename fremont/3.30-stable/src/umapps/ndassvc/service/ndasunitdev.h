...
public:
	...
	STDMETHODIMP CheckNDFSCompatibility();
	...
	STDMETHODIMP GetRaidSimpleStatus(__out DWORD* RaidSimpleStatusFlags, __in NDAS_LOGICALUNIT_DEFINITION *NdasLogicalUnitDefinition);
