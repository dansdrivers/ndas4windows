...
inline CString
pHWVersionString(__in const NDAS_DEVICE_HARDWARE_INFO* NdasDeviceHardwareInfo)
{
	CString s; return pHWVersionString(s, NdasDeviceHardwareInfo);
}
...
{
	CString s; return pLogicalDeviceStatusString(s, status, lerror, access);
}
