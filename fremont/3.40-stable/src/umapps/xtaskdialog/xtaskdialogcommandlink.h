...
class CXTASKDIALOG_EXT_CLASS CXTaskDialogCommandLink : public CWindowImpl<CXTaskDialogCommandLink>
{
public:
//Constructors / Destructors
	CXTaskDialogCommandLink() : 
		m_penHotOutline(NULL),
...
protected:
	...
	LRESULT OnDrawItem(UINT /*nMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL& /*bHandled*/)
	{
		...
		if (hIcon)
		{
			int nY = rClient.top + 2 * SpacingSize; // (rClient.Height() - 16) / 2;
			::DrawIconEx(lpDrawItem->hDC, nX, nY, hIcon, 16, 16, 0, NULL, DI_NORMAL);
			nX += (16 + 2*SpacingSize);
		}
	...
	LRESULT OnEraseBackground(UINT /*nMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
	{
		...
		//performance we do not erasting here
		return 1;
	}
