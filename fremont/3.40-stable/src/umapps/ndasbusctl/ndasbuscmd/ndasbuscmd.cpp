	  ...
	  ULONG ulStatus;
		...
		if(bret == FALSE) {
			...
			for(idx_ud = 0; idx_ud < lurFullInfo->LurnCnt; idx_ud++) {
				...
				_tprintf(TEXT("NetDiskAddress.Address[0].Address        :%04X | %02X %02X %02X %02X %02X %02X\n"),
													(int)unitDisk->NetDiskAddress.Address[0].NdasAddress.Lpx.Port,
													(int)unitDisk->NetDiskAddress.Address[0].NdasAddress.Lpx.Node[0],
													(int)unitDisk->NetDiskAddress.Address[0].NdasAddress.Lpx.Node[1],
													(int)unitDisk->NetDiskAddress.Address[0].NdasAddress.Lpx.Node[2],
													(int)unitDisk->NetDiskAddress.Address[0].NdasAddress.Lpx.Node[3],
													(int)unitDisk->NetDiskAddress.Address[0].NdasAddress.Lpx.Node[4],
													(int)unitDisk->NetDiskAddress.Address[0].NdasAddress.Lpx.Node[5]
													);
				...
				_tprintf(TEXT("BindingAddress.Address[0].Address        :%04X | %02X %02X %02X %02X %02X %02X\n"),
													(int)unitDisk->BindingAddress.Address[0].NdasAddress.Lpx.Port,
													(int)unitDisk->BindingAddress.Address[0].NdasAddress.Lpx.Node[0],
													(int)unitDisk->BindingAddress.Address[0].NdasAddress.Lpx.Node[1],
													(int)unitDisk->BindingAddress.Address[0].NdasAddress.Lpx.Node[2],
													(int)unitDisk->BindingAddress.Address[0].NdasAddress.Lpx.Node[3],
													(int)unitDisk->BindingAddress.Address[0].NdasAddress.Lpx.Node[4],
													(int)unitDisk->BindingAddress.Address[0].NdasAddress.Lpx.Node[5]
													);
