...
public:
	...
	BEGIN_MSG_MAP_EX(CRegWizIntroPage)
		...
		COMMAND_HANDLER_EX(IDC_NDAS_PNP, BN_CLICKED, OnNoWriteKeyClick)
	END_MSG_MAP()
...
{
	CEdit m_NdasStringId[NDAS_DEVICE_STRING_ID_PARTS];
	CEdit m_DevKey;
...
public:
	...
	CRegWizard(HWND hWndParent = NULL, 	PTCHAR NdasStringId = NULL);
