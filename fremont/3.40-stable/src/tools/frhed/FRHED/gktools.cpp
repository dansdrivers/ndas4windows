...
//					switch(GetWindowTextLength(hEditID))
					...
					case 12:
						...
						STR_TO_MAC(i, NdasConnectionInfo.Address.DeviceId.Node, buf, 2);
						break;
					case 17:
						NdasConnectionInfo.AddressType = NDASCOMM_CIT_DEVICE_ID;
						STR_TO_MAC(i, NdasConnectionInfo.Address.DeviceId.Node, buf, 3);
						break;
					case 20:
						...
						CopyMemory(NdasConnectionInfo.Address.NdasIdA.Id, buf, 20);
						break;
					case 23:
						if(NdasConnectionInfo.WriteAccess)
						{
						...
						NdasConnectionInfo.AddressType = NDASCOMM_CIT_NDAS_IDA;
						CopyMemory(NdasConnectionInfo.Address.NdasIdA.Id, buf, 5);
						CopyMemory(NdasConnectionInfo.Address.NdasIdA.Id +5, buf +6, 5);
						CopyMemory(NdasConnectionInfo.Address.NdasIdA.Id +10, buf +12, 5);
						CopyMemory(NdasConnectionInfo.Address.NdasIdA.Id +15, buf +18, 5);
						break;
					case 25:
						NdasConnectionInfo.AddressType = NDASCOMM_CIT_NDAS_IDA;
						CopyMemory(NdasConnectionInfo.Address.NdasIdA.Id, buf, 20);
						CopyMemory(NdasConnectionInfo.Address.NdasIdA.Key, buf +20, 5);
						break;
					case 29:
						NdasConnectionInfo.AddressType = NDASCOMM_CIT_NDAS_IDA;
						CopyMemory(NdasConnectionInfo.Address.NdasIdA.Id, buf, 5);
						...
						CopyMemory(NdasConnectionInfo.Address.NdasIdA.Id +10, buf +12, 5);
						CopyMemory(NdasConnectionInfo.Address.NdasIdA.Id +15, buf +18, 5);
						CopyMemory(NdasConnectionInfo.Address.NdasIdA.Key, buf +24, 5);
						break;
					default:
