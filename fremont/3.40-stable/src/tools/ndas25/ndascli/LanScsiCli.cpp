...
//	changed by ILGU 2003_0819
	...
	for(int i = 0; i < pParam->NRTarget; i++) {
		...
		if (ActiveHwVersion == LANSCSIIDE_VERSION_2_5) {
			...
			PerTarget[iTargetId].NREWHost = pTarget->V2.NREWHost;
			PerTarget[iTargetId].NRSWHost = pTarget->V2.NRSWHost;
			PerTarget[iTargetId].NRROHost = pTarget->V2.NRROHost;
		} else {
			...
			PerTarget[iTargetId].NREWHost = pTarget->V1.NRRWHost;
			PerTarget[iTargetId].NRROHost = pTarget->V1.NRROHost;
		}
...
int __cdecl lsmain(int argc, char* argv[])
{
