...
typedef struct _LURNDESC_IDE {
	...
	TA_NDAS_ADDRESS			TargetAddress;	// sizeof(TA_NDAS_ADDRESS) == 26 bytes
...
typedef struct _LURELATION_NODE_DESC {
	...
	union {
		...
		UINT8				InitData[LURNDESC_INITDATA_BUFFERLEN];
...
#define LUROPTION_DONOT_ADJUST_PRIM_SEC_ROLE	0x10000000
#define LUROPTION_REDUCE_TIMEOUT				0x20000000
