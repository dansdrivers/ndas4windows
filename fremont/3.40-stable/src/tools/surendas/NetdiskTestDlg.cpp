...
BOOL CNetdiskTestDlg::OnInitDialog()
{
	...
	GetDlgItem(IDC_EDIT_ETH0)->SetWindowPos(&wndTop,  20, 100, 300,  20, SWP_SHOWWINDOW);
	GetDlgItem(IDC_EDIT_ETH1)->SetWindowPos(&wndTop,  20, 160, 300,  20, SWP_SHOWWINDOW);
	GetDlgItem(IDC_EDIT_ETH2)->SetWindowPos(&wndTop,  20, 220, 300,  20, SWP_SHOWWINDOW);
	GetDlgItem(IDC_EDIT_ETH3)->SetWindowPos(&wndTop,  20, 280, 300,  20, SWP_SHOWWINDOW);

	GetDlgItem(IDC_EDIT_ETH4)->SetWindowPos(&wndTop, 375, 100, 300,  20, SWP_SHOWWINDOW);
	GetDlgItem(IDC_EDIT_ETH5)->SetWindowPos(&wndTop, 375, 160, 300,  20, SWP_SHOWWINDOW);
	GetDlgItem(IDC_EDIT_ETH6)->SetWindowPos(&wndTop, 375, 220, 300,  20, SWP_SHOWWINDOW);
	GetDlgItem(IDC_EDIT_ETH7)->SetWindowPos(&wndTop, 375, 280, 300,  20, SWP_SHOWWINDOW);
