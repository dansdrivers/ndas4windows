 ...
 */
int UDFFindPartition( dvd_reader_t *device, int partnum,
		      ...
		      uint32_t *filesize )
{
    ...
    *filesize = 0;
    tokenline[0] = '\0';
    strcat_s( tokenline,MAX_UDF_FILE_NAME_LEN, filename );
    ...
    /* Tokenize filepath */
    token = strtok_s(tokenline, "/", &next_token);
    while( token != NULL ) {
