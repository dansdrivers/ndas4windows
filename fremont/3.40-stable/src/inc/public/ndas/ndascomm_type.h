...
typedef enum _NDASCOMM_CONNECTION_FLAG {
	...
	NDASCOMM_CNF_CONNECT_ONLY                    = 0x00000100,
...
typedef enum _NDASCOMM_VCMD_COMMAND
{
	...
	ndascomm_vcmd_set_eep = 0x2a,
	ndascomm_vcmd_get_eep = 0x2b,
...
typedef union _NDASCOMM_VCMD_PARAM
{
	...
	/*
		ndascomm_vcmd_set_eep, ndascomm_vcmd_get_eep
	*/
	struct {
		UINT32 Address; /* Should be 16 byte aligned. */
		UINT8   Data[16];
	} GETSET_EEPROM;
