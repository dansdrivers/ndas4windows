...
typedef struct _TDI_ADDRESS_LPX {
	USHORT	Port;
	UCHAR	Node[6];
...
static UCHAR LpxBroadcastAddress[6] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
static UCHAR LpxZeroAddress[6] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
