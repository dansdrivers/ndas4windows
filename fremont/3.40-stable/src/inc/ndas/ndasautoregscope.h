...
//
// inline implementation for compatibility reasons
// there are several non-trivial problems using c++ static libraries
// including multiple symbol conflict.
//
...
static LPCTSTR NDAS_SYS_SERVICE_REGKEY	= _T("ndassvc\\ARFlags");
static LPCTSTR NDAS_SYS_ARFLAGS_REGVAL	= _T("Data");
