...
#define XTL_TRACE_LEVEL TRACE_LEVEL_ERROR
#endif
#else
#ifndef XTL_TRACE_CATEGORY
	...
	LPCSTR Format, va_list va)
{
	...
	else
	{
		hr = ::StringCchPrintfExA(
			p, r, &p, &r, 0,
			"%hs!%hs (%d): ", 
			XtlTraceModuleName, Function, Level);
...
#define XTLTRACE_DEFAULT_LEVEL TRACE_LEVEL_ERROR
#endif
...
#if !defined(XTLTRACE_MODULE_NAME_USE_EXTENSION)
		LPSTR p2 = moduleName;
		while (*p2 != 0) ++p2;
