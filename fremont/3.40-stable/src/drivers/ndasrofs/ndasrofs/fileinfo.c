...

{
	...
	if (NdasNtfsSeAuditHardLinkCreation == NULL) {
    ...
    try {
        ...
        if (NdasNtfsSeAuditingHardLinkEvents( TRUE, SecurityDescriptor )) {
            ...
            try {
                ...
                NdasNtfsSeAuditHardLinkCreation( &DeviceAndOldLinkName,
												 &DeviceAndNewLinkName,
												 TRUE );
