...
#else
#define NtfsGenerateHashFromUlong(U) (									\
	(ULONG)(HASH_STRING_CONVERT_CONSTANT * (U)) % HASH_STRING_PRIME		\
	)
#endif
...
typedef struct _VCB {
	...
	LONG CleanupCount;
    LONG CloseCount;
    LONG ReadOnlyCloseCount;
    LONG SystemFileCloseCount;

	UCHAR LastAcquireFile[16];
	ULONG LastAcquireLine;

	UCHAR LastReleaseFile[16];
...
#define ND_NTFS_VCB_FLAG_TRY_CLOSE_FILES	0x00000001
	
	LONG				SecondaryCleanupCount;
	LONG				SecondaryCloseCount;
	LONG				SecondaryReadOnlyCloseCount;
	LONG				SecondarySystemFileCloseCount;

	RTL_GENERIC_TABLE	SecondaryFcbTable;

	CLONG				SecondaryQueuedCloseCount;

	ERESOURCE			SecondaryResource;
...
#define NDAS_NTFS_DEVICE_FLAG_INITIALIZING			0x00000001
#define NDAS_NTFS_DEVICE_FLAG_MOUNTED				0x00000002
#define NDAS_NTFS_DEVICE_FLAG_SHUTDOWN				0x00000004

#define NDAS_NTFS_DEVICE_FLAG_DIRECT_RW				0x00000010

#define NDAS_NTFS_DEVICE_FLAG_WAIT_CLOSE_LOGFILE	0x00000100
...
#if __NDAS_NTFS_PURGE__
#define FS_BUFFER_SIZE				PAGE_SIZE
	UCHAR							Buffer[FS_BUFFER_SIZE];
#endif
	...
	KEVENT							ReadyEvent;
	KEVENT							RequestEvent;
	KEVENT							LogFileCloseEvent;

	struct {

#define VOLDO_THREAD_FLAG_INITIALIZING			0x00000001
#define VOLDO_THREAD_FLAG_START					0x00000002
#define VOLDO_THREAD_FLAG_STOPED				0x00000004
#define VOLDO_THREAD_FLAG_TERMINATED			0x00000008

#define VOLDO_THREAD_FLAG_CONNECTED				0x00000010
#define VOLDO_THREAD_FLAG_DISCONNECTED			0x00000020

#define VOLDO_THREAD_FLAG_UNCONNECTED			0x10000000
#define VOLDO_THREAD_FLAG_REMOTE_DISCONNECTED	0x20000000
#define VOLDO_THREAD_FLAG_ERROR					0x80000000
...
#define NDAS_NTFS_FCB_FLAG_SECONDARY		0x00000001

	LIST_ENTRY	DeletedListEntry;		
...
typedef struct _SCB {
	...
	ULONG				CorruptedCcbCloseCount;

#define ND_NTFS_SCB_FLAG_CORRUPTED	0x00000001
	ULONG				NdasNtfsFlags;

	UINT64				Handle;

#if __NDAS_NTFS_DBG__
	UCHAR LastUpdateFile[16];
	ULONG LastUpdateLine;
#endif
...
#if (__NDAS_NTFS_SECONDARY__ || __NDAS_NTFS_PRIMARY__) 

	struct _SECONDARY		*Secondary;

	ULONG					NdasNtfsFlags;

#define ND_NTFS_CCB_FLAG_UNOPENED		0x00000001
#define ND_NTFS_CCB_FLAG_REOPENED		0x00000002
#define ND_NTFS_CCB_FLAG_CORRUPTED		0x00000004

#define ND_NTFS_CCB_FLAG_DELAY_CLOSE	0x00000100

#define ND_NTFS_CCB_FLAG_READONLY		0x00001000

	PRIMARY_SESSION_ID		FileOpenPrimarySessionId;
...
typedef struct _PRIMARY_REQUEST_INFO {

	ULONG										PrimaryTag;
	PRIMARY_SESSION_ID							PrimarySessionId;
	struct _PRIMARY_SESSION						*PrimarySession;
	UNALIGNED struct _NDFS_WINXP_REQUEST_HEADER	*NdfsWinxpRequestHeader;

} PRIMARY_REQUEST_INFO, *PPRIMARY_REQUEST_INFO;
...
#define NDAS_NTFS_IRP_CONTEXT_FLAG_SECONDARY_CONTEXT					0x00000001

#define NDAS_NTFS_IRP_CONTEXT_FLAG_SECONDARY_FILE						0x00000010
#define NDAS_NTFS_IRP_CONTEXT_FLAG_SECONDARY_CREATE_FILE				0x00000020
#define NDAS_NTFS_IRP_CONTEXT_FLAG_ALREADY_COMPLETED					0x00000080

#define NDAS_NTFS_IRP_CONTEXT_FLAG_TRY_CLOSE_FILES						0x00000100

#define NDAS_NTFS_IRP_CONTEXT_FLAG_FLUSH								0x00001000
#define NDAS_NTFS_IRP_CONTEXT_FLAG_PURGE								0x00002000

#define NDAS_NTFS_IRP_CONTEXT_FLAG_PRIMARY_STOPPING						0x00010000

#define NDAS_NTFS_IRP_CONTEXT_FLAG_ALREADY_OPENED_BY_PRIMARY_SESSION	0x01000000
#define NDAS_NTFS_IRP_CONTEXT_FLAG_OPEN_TRY_ON_SECONDARY				0x02000000
	...
	PIRP				CompleteIrp;
	PIO_STACK_LOCATION	CompleteIrpSp;
	KIRQL				CurrentIrql;

	ULONG				VcbSharedCount;

	BOOLEAN				VcbAcquiredResult;
