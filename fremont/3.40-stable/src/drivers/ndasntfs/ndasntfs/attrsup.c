...

{
	...
	NDAS_ASSERT( CONTAINING_RECORD(Fcb->Vcb, VOLUME_DEVICE_OBJECT, Vcb)->NetdiskEnableMode != NETDISK_SECONDARY );
...

{
    ...
    if (FlagOn( AttributeFlags, ATTRIBUTE_FLAG_COMPRESSION_MASK | ATTRIBUTE_FLAG_SPARSE )) {
        ...
        ClustersInCompressionUnit = (LONGLONG)1 << CompressionShift;
