...
typedef struct _LPX_NDIS_IDENTIFICATION {
...
} LPX_NDIS_IDENTIFICATION, *PLPX_NDIS_IDENTIFICATION;
...
#define LpxSetNdisPacketLength(_packet,_length) {              \
