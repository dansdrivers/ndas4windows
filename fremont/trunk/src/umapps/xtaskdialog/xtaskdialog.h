...
//Enums
	enum
	{
		...
		ProgressControlHeight		   = 19, // 14,   //The height of the progress control
		SpacingSize					   = 6, // 5,	   //The minimum distance between dialog controls
...
//Member variables
	...
	DWORD							  m_dwLastTickCount;				 //The tick count we pass in TDN_TIMER notifications
	...
	CXTaskDialogHyperLink m_ctrlMainInstructionTextLink;
	CXTaskDialogHyperLink m_ctrlFooterTextLink;
	CXTaskDialogHyperLink m_ctrlContentTextLink;
	CXTaskDialogHyperLink m_ctrlExpandedTextLink;

	CContainedWindow m_ctrlExpandedTextEx;
