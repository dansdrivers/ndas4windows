...
protected:
	...
	BOOL m_bSort;
//	NBUnitDevPtrMap m_mapUnitDevices;
...
public:
	...
	int FindDiskObjectItem(CNBLogicalDev *o);
	void AddDiskObject(CNBLogicalDev *o);
	void AddDiskObjectList(NBLogicalDevPtrList &mapUnitDevices);
	void DeleteDiskObject(CNBLogicalDev *o);
	void DeleteDiskObjectList(NBLogicalDevPtrList &mapUnitDevices);
	void SelectDiskObject(CNBLogicalDev *o);
	void UnselectDiskObject(CNBLogicalDev *o);
	void SelectDiskObjectList(NBLogicalDevPtrList &mapUnitDevices);
	void SelectAllDiskObject();
	//
	// Returns list of disks in the listview
	//
	NBLogicalDevPtrList GetDiskObjectList();
	NBLogicalDevPtrList GetSelectedDiskObjectList();
	...
	virtual int  CompareItems(CNBLogicalDev *obj1, CNBLogicalDev *obj2);
};
