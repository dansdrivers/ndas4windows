...
#define _ENABLE_RAID4_RAID5_BTN_ON_BINDDLG_	1
...
namespace nbbwiz  {
	...
	typedef struct _WIZARD_DATA {
		...
		NBLogicalDevPtrList listUnitDevicesBind;
	...
	public:
		...
		void SetSingleDisks (CMainFrame	*mainFrame, NBLogicalDevPtrList &listUnitDevicesSingle);
	};
