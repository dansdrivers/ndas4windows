...
#define LANSCSIIDE_VERSION_2_5			3
...
//	Each unit device has different Buffer lock by adding unit device number
//	to the base lock index below.
//

#define LOCKIDX_BASE_NDASBUFFER			0
...
#define VENDOR_OP_SET_SEMA					VENDOR_OP_SET_MUTEX			// frame.vhd : VENDOR_SET_SEMA. Remained for source backward compatability. Remove later after source review.
#define VENDOR_OP_FREE_SEMA					VENDOR_OP_FREE_MUTEX		// frame.vhd : VENDOR_FREE_SEMA. Remained for source backward compatability. Remove later after source review.
#define VENDOR_OP_GET_SEMA					VENDOR_OP_GET_MUTEX_INFO	// frame.vhd : VENDOR_GET_SEMA. Remained for source backward compatability. Remove later after source review.
#define VENDOR_OP_OWNER_SEMA				VENDOR_OP_GET_MUTEX_OWNER	// frame.vhd : VENDOR_GET_OWNER_SEMA. Remained for source backward compatability. Remove later after source review.
...
#define VENDOR_OP_GET_D_OPT					VENDOR_OP_GET_D_ENC  // Added at 2.5 and changed name
...
#define VENDOR_OP_SET_EEP					0x2A	// Added at 2.0
#define VENDOR_OP_GET_EEP					0x2B	// Added at 2.0
