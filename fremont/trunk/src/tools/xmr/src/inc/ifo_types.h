#ifndef __DVDREAD_IFO_TYPES_H__
#define __DVDREAD_IFO_TYPES_H__
...
typedef struct {
  ...
  unsigned short mpeg_version         : 2;
  unsigned short video_format         : 2;
  unsigned short display_aspect_ratio : 2;
  unsigned short permitted_df         : 2;
  
  unsigned short line21_cc_1          : 1;
  unsigned short line21_cc_2          : 1;
  unsigned short unknown1             : 2;
  
  unsigned short picture_size         : 2;
  unsigned short letterboxed          : 1;
  unsigned short film_mode            : 1;
#else
  unsigned short permitted_df         : 2;
  unsigned short display_aspect_ratio : 2;
  unsigned short video_format         : 2;
...
typedef struct {
#ifdef WORDS_BIGENDIAN
  unsigned short audio_format           : 3;
  unsigned short multichannel_extension : 1;
  unsigned short lang_type              : 2;
  unsigned short application_mode       : 2;
  
  unsigned short quantization           : 2;
  unsigned short sample_frequency       : 2;
...
typedef struct {
#ifdef WORDS_BIGENDIAN
  unsigned short block_mode       : 2;
  unsigned short block_type       : 2;
  unsigned short seamless_play    : 1;
  unsigned short interleaved      : 1;
  unsigned short stc_discontinuity: 1;
  unsigned short seamless_angle   : 1;
  
  unsigned short unknown1         : 1;
  unsigned short restricted       : 1;
