...
%CLI% rawvendor %TARGET% 0x4 0x01 "" 0 29 0
echo ## Check changes
...
%CLI% rawvendor %TARGET% 0x4 0x01 "" 0 499 0
echo ## Check changes
%CLI% Getconfig %TARGET%
echo ## Set incoming packet drop
%CLI% SetPacketDrop rx 1
...
echo ### Start IO
call lockedwrite %IOSIZE% %ITE% %POS% 0x4
