...
#define __NDAS_FAT_SHARE_READ__				1

#define __NDAS_FAT_DISABLE_BUGCHECK__		1
...
#define __NDAS_FAT_FORCE_HANDLE_0__			1
...
#define NDASFAT_LOCAL_PRMARY_SESSION_ID	((PRIMARY_SESSION_ID)0)
