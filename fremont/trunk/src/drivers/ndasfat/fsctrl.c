...
if (IS_WINDOWS2K()) {
							...
							DebugTrace2( 0, Dbg2, ("EndOfPartition = %I64d, StartingOffset = %I64d, Length = %I64d, AccessMode = %x\n",
													VolDo->NetdiskPartitionInformation.PartitionInformation.StartingOffset.QuadPart + VolDo->NetdiskPartitionInformation.PartitionInformation.PartitionLength.QuadPart,
													bacl->BlockACEs[baceCount].StartingOffset, bacl->BlockACEs[baceCount].Length,
													bacl->BlockACEs[baceCount].AccessMode) );

							if (VolDo->NetdiskPartitionInformation.PartitionInformation.StartingOffset.QuadPart >= bacl->BlockACEs[baceCount].StartingOffset &&
								VolDo->NetdiskPartitionInformation.PartitionInformation.StartingOffset.QuadPart 
									< bacl->BlockACEs[baceCount].StartingOffset + bacl->BlockACEs[baceCount].Length) {
								...
								NDAS_ASSERT( VolDo->NetdiskPartitionInformation.PartitionInformation.StartingOffset.QuadPart + VolDo->NetdiskPartitionInformation.PartitionInformation.PartitionLength.QuadPart >= bacl->BlockACEs[baceCount].StartingOffset &&
											 VolDo->NetdiskPartitionInformation.PartitionInformation.StartingOffset.QuadPart + VolDo->NetdiskPartitionInformation.PartitionInformation.PartitionLength.QuadPart <= bacl->BlockACEs[baceCount].StartingOffset + bacl->BlockACEs[baceCount].Length );
							...
							if (VolDo->NetdiskPartitionInformation.PartitionInformationEx.StartingOffset.QuadPart >= (INT64)bacl->BlockACEs[baceCount].StartingOffset &&
								...
								NDAS_ASSERT( VolDo->NetdiskPartitionInformation.PartitionInformationEx.StartingOffset.QuadPart + VolDo->NetdiskPartitionInformation.PartitionInformationEx.PartitionLength.QuadPart >= bacl->BlockACEs[baceCount].StartingOffset &&
											 VolDo->NetdiskPartitionInformation.PartitionInformationEx.StartingOffset.QuadPart + VolDo->NetdiskPartitionInformation.PartitionInformationEx.PartitionLength.QuadPart <= bacl->BlockACEs[baceCount].StartingOffset + bacl->BlockACEs[baceCount].Length );
...
if (IS_WINDOWS2K()) {
						...
						DebugTrace2( 0, Dbg2, ("StartOfPartition = %I64d, EndOfPartition = %I64d, StartingOffset = %I64d, Length = %I64d, AccessMode = %x\n",
												VolDo->NetdiskPartitionInformation.PartitionInformation.StartingOffset.QuadPart,
												VolDo->NetdiskPartitionInformation.PartitionInformation.StartingOffset.QuadPart + VolDo->NetdiskPartitionInformation.PartitionInformation.PartitionLength.QuadPart,
												bacl->BlockACEs[baceCount].StartingOffset, bacl->BlockACEs[baceCount].Length,
												bacl->BlockACEs[baceCount].AccessMode) );
