...
typedef struct _FAT_DATA {
	...
	UNICODE_STRING	Root;
	WCHAR			RootBuffer[NDFS_MAX_PATH];
...
typedef struct _VCB {
	...
	LONG		PrimaryOpenFileCount;
	LONG		SecondaryOpenFileCount;
...
#define ND_FAT_DEVICE_FLAG_INITIALIZING				0x00000001
#define ND_FAT_DEVICE_FLAG_MOUNTED					0x00000002
#define ND_FAT_DEVICE_FLAG_SHUTDOWN					0x00000004

#define ND_FAT_DEVICE_FLAG_DIRECT_RW				0x00000100
#define ND_FAT_DEVICE_FLAG_LINKSYS_SUPPORT			0x00000200
...
#define ND_FAT_FCB_FLAG_SECONDARY	0x00000001
#define ND_FAT_FCB_FLAG_CORRUPTED	0x00000002
...
#define ND_FAT_CCB_FLAG_UNOPENED		0x00000001
#define ND_FAT_CCB_FLAG_REOPENED		0x00000002
#define ND_FAT_CCB_FLAG_CORRUPTED		0x00000004
#define ND_FAT_CLEANUP_COMPLETE			0x00000008

#define ND_FAT_CCB_FLAG_DELAY_CLOSE		0x00000100

#define ND_FAT_CCB_FLAG_READONLY		0x00001000
...
#define NDAS_FAT_IRP_CONTEXT_FLAG_SECONDARY_CONTEXT					0x00000001
#define NDAS_FAT_IRP_CONTEXT_FLAG_DONT_POST_REQUEST					0x00000002
#define NDAS_FAT_IRP_CONTEXT_FLAG_SECONDARY_RESOURCE_ACQUIRED		0x00000004

#define NDAS_FAT_IRP_CONTEXT_FLAG_SECONDARY_CREATE_FILE				0x00000020
#define NDAS_FAT_IRP_CONTEXT_FLAG_ALREADY_COMPLETED					0x00000080

#define NDAS_FAT_IRP_CONTEXT_FLAG_TRY_CLOSE_FILES					0x00000100

#define NDAS_FAT_IRP_CONTEXT_FLAG_FLUSH								0x00001000
#define NDAS_FAT_IRP_CONTEXT_FLAG_PURGE								0x00002000

#define NDAS_FAT_IRP_CONTEXT_FLAG_PRIMARY_STOPPING					0x00010000
#define NDAS_FAT_IRP_CONTEXT_FLAG_PRIMARY_SURPRISE_REMOVAL			0x00020000

#define NDAS_FAT_IRP_CONTEXT_FLAG_ALREADY_OPENED_BY_PRIMARY_SESSION	0x01000000
#define NDAS_FAT_IRP_CONTEXT_FLAG_OPEN_TRY_ON_SECONDARY				0x02000000

#define NDAS_FAT_IRP_CONTEXT_VCB_DELETED							0x10000000
	...
	IO_STATUS_BLOCK			OriginalIrpIoStatus;
...
#define FatIsTopLevelRequest(IrpContext)	(IrpContext->TopLevel)
