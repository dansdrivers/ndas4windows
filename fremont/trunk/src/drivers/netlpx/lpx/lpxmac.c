...
#if __LPX__
	NDAS_ASSERT( DeviceMaxFrameSize >= LPX_MAX_DATAGRAM_SIZE + sizeof(LPX_HEADER) + 14 );
...
--*/
{
	...
	NDAS_ASSERT( Type == NdisMedium802_3 );
	...
	case NdisMediumDix: {
		...
		RtlCopyMemory( Buffer, LpxBroadcastAddress, ETHERNET_ADDRESS_LENGTH );
		break;
	}
