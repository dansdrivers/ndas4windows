...
extern BOOLEAN NdasPortIsWindowsXPOrLater;
...
BOOLEAN
NdasPortExIsLogicalUnitStarted(
	__in PNDAS_LOGICALUNIT_EXTENSION LogicalUnitExtension);
...
typedef
NTSTATUS
NDAS_LU_QUERY_NDAS_LOGICALUNIT_INTERFACE(
...
typedef NDAS_LU_QUERY_NDAS_LOGICALUNIT_INTERFACE *PNDAS_LU_QUERY_NDAS_LOGICALUNIT_INTERFACE;
...
typedef NDAS_LU_INITIALIZE *PNDAS_LU_INITIALIZE;
...
typedef NDAS_LU_CLEANUP *PNDAS_LU_CLEANUP;

typedef
NTSTATUS
NDAS_LU_LOGICALUNIT_CONTROL(
	__in PNDAS_LOGICALUNIT_EXTENSION LogicalUnitExtension,
	__in NDAS_LOGICALUNIT_CONTROL_TYPE ControlType,
	__in PVOID Parameters);

typedef NDAS_LU_LOGICALUNIT_CONTROL *PNDAS_LU_LOGICALUNIT_CONTROL;

typedef
NTSTATUS
NDAS_LU_QUERY_PNP_ID(
	__in PNDAS_LOGICALUNIT_EXTENSION LogicalUnitExtension,
	__in BUS_QUERY_ID_TYPE QueryType,
	__in ULONG Index,
	__inout PUNICODE_STRING DeviceId);

typedef NDAS_LU_QUERY_PNP_ID *PNDAS_LU_QUERY_PNP_ID;
...
typedef
NTSTATUS
NDAS_LU_QUERY_PNP_DEVICE_CAPABILITIES(
	__in PNDAS_LOGICALUNIT_EXTENSION LogicalUnitExtension,
	__in PDEVICE_CAPABILITIES Capabilities);

typedef NDAS_LU_QUERY_PNP_DEVICE_CAPABILITIES *PNDAS_LU_QUERY_PNP_DEVICE_CAPABILITIES;

typedef
NTSTATUS
NDAS_LU_QUERY_STORAGE_DEVICE_PROPERTY(
	__in PNDAS_LOGICALUNIT_EXTENSION LogicalUnitExtension,
	__out_bcount(BufferLength) PSTORAGE_DEVICE_DESCRIPTOR DeviceDescriptor,
	__in ULONG BufferLength,
	__out PULONG ResultLength);

typedef NDAS_LU_QUERY_STORAGE_DEVICE_PROPERTY *PNDAS_LU_QUERY_STORAGE_DEVICE_PROPERTY;

typedef
NTSTATUS
NDAS_LU_QUERY_STORAGE_ADAPTER_PROPERTY(
	__in PNDAS_LOGICALUNIT_EXTENSION LogicalUnitExtension,
	__out_bcount(BufferLength) PSTORAGE_ADAPTER_DESCRIPTOR DeviceDescriptor,
	__in ULONG BufferLength,
	__out PULONG ResultLength);

typedef NDAS_LU_QUERY_STORAGE_ADAPTER_PROPERTY *PNDAS_LU_QUERY_STORAGE_ADAPTER_PROPERTY;

typedef
NTSTATUS
NDAS_LU_QUERY_STORAGE_DEVICE_ID_PROPERTY(
	__in PNDAS_LOGICALUNIT_EXTENSION LogicalUnitExtension,
	__out_bcount(BufferLength) PSTORAGE_DEVICE_ID_DESCRIPTOR DeviceIdDescriptor,
	__in ULONG BufferLength,
	__out PULONG ResultLength);

typedef NDAS_LU_QUERY_STORAGE_DEVICE_ID_PROPERTY *PNDAS_LU_QUERY_STORAGE_DEVICE_ID_PROPERTY;
...
typedef NDAS_LU_BUILD_IO *PNDAS_LU_BUILD_IO;
...
typedef NDAS_LU_START_IO *PNDAS_LU_START_IO;
...
typedef struct _NDAS_LOGICALUNIT_INTERFACE {
	...
	// Passive level
	PNDAS_LU_QUERY_STORAGE_ADAPTER_PROPERTY QueryStorageAdapterProperty;
} NDAS_LOGICALUNIT_INTERFACE, *PNDAS_LOGICALUNIT_INTERFACE;
