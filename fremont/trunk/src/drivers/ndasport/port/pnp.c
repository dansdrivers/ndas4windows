	...
	__in PNDASPORT_FDO_EXTENSION FdoExtension)
{
	...
	//
	// When FDO is started, it is likely that network providers are not ready
	// yet. We will rely on NdasPortFdoBindChangeHandler and 
	// NdasPortFdoAddNetAddressHandler functions to call NdasPortFdoInitializeLogicalUnits
	//

	//
	// First attempt to mount the logical units

	// ** Disabled calling NdasPortFdoInitializeLogicalUnits here**
    ...
    __in PIRP Irp)
{
    ...
    case IRP_MN_QUERY_REMOVE_DEVICE: 
		...
		//
		// Set the status to STATUS_SUCCESS before forwarding
		//
		Irp->IoStatus.Status = STATUS_SUCCESS;
