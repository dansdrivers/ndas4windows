...
#define LFS_NETDISK_MANAGER_TIME_OUT		(30 * NANO100_PER_SEC)  // This timeout should not happen. Because of possible delay in ConnectToPrimary, set to at least over 120 sec
