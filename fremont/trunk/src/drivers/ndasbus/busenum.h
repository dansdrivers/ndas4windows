...
#define BUSENUM_POOL_TAG						(ULONG) 'egBN'
#define BUSENUM_POOL_TAG_DRIVER_REGISTRYPATH	(ULONG) 'grBN'
#define BUSENUM_LURDESC_TAG						(ULONG) 'dlBN'

#define BUSENUM_COMPATIBLE_IDS L"LanscsiBus\\LanscsiMiniport\0"
#define BUSENUM_COMPATIBLE_IDS_LENGTH sizeof(BUSENUM_COMPATIBLE_IDS) // length in bytes
...
#define DBG_LEVEL_BUS_EMUM		2
#define DBG_LEVEL_BUS_PNP		2
#define DBG_LEVEL_BUS_PDO_PNP	2
#define DBG_LEVEL_NDAS_BUS		2
#define DBG_LEVEL_BUS_REG		2
#define DBG_LEVEL_BUS_UTIL		2
#define DBG_LEVEL_BUS_PWR		2
...
#define BUS_DEFAULT_DEBUG_OUTPUT_LEVEL	0x00000000
...
NTSTATUS
Bus_PDO_QueryFilterResourceRequirement (
