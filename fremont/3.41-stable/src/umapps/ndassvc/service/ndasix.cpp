...
LONG DbgLevelSvcIx = DBG_LEVEL_SVC_IX;
...
CNdasIXBcast::Initialize()
{
	...
	success = ::LfsFiltCtlGetVersion( NULL, NULL, NULL, NULL, &m_NDFSVersion.wMajor, &m_NDFSVersion.wMinor );

	NdasUiDbgCall( 1, "m_NDFSVersion.wMajor = %x, m_NDFSVersion.wMinor = %x\n", 
					   m_NDFSVersion.wMajor, m_NDFSVersion.wMinor );
	if (!success) {
