...
namespace ndas {
	...
	public:
		...
		NDAS_DEVICE_ERROR GetNdasDeviceError();
		LPCTSTR GetStringId();
	...
	public:
		...
		NDAS_UNITDEVICE_ERROR GetNdasUnitError();
	...
	public:
		...
		NDAS_LOGICALDEVICE_ERROR GetNdasLogicalUnitError();
		...
		BOOL PlugIn(BOOL bReadWrite = false, BOOL bIgnoreWarning = false);
		BOOL Eject();
