...
CSetupLauncher::Run(int argc, TCHAR** argv)
{
	...
	ATLTRACE( _T("SystemInfo.wProcessorArchitecture = %d\n"), SystemInfo.wProcessorArchitecture );
#endif
	...
	if (kernel32.IsProcAvailable("GetNativeSystemInfo")) {
		...
		ATLTRACE( _T("GetNativeSystemInfo SystemInfo.wProcessorArchitecture = %d, IsWow64() = %d\n"), 
				  SystemInfo.wProcessorArchitecture, IsWow64() );
		...
		ATLTRACE( _T("GetSystemInfo SystemInfo.wProcessorArchitecture = %d\n"), SystemInfo.wProcessorArchitecture );
