...
#define u4byte_in(__ARG__)   (*(u4byte*)(__ARG__))
#define u4byte_out(__PTR__,__ARG_)   (*(u4byte*)(__PTR__))=(__ARG_)

void  rijndael_set_key(const u1byte in_key[], const u4byte key_len);
void  rijndael_encrypt(const u1byte in_blk[16], u1byte out_blk[16]);
void  rijndael_decrypt(const u1byte in_blk[16], u1byte out_blk[16]);

void  serpent_set_key(const u1byte in_key[], const u4byte key_len);
void  serpent_encrypt(const u1byte in_blk[16], u1byte out_blk[16]);
void  serpent_decrypt(const u1byte in_blk[16], u1byte out_blk[16]);

void  rc6_set_key(const u1byte in_key[], const u4byte key_len);
void  rc6_encrypt(const u1byte in_blk[16], u1byte out_blk[16]);
void  rc6_decrypt(const u1byte in_blk[16], u1byte out_blk[16]);

void  twofish_set_key(const u1byte in_key[], const u4byte key_len);
void  twofish_encrypt(const u1byte in_blk[16], u1byte out_blk[16]);
void  twofish_decrypt(const u1byte in_blk[16], u1byte out_blk[16]);

void  mars_set_key(const u1byte in_key[], const u4byte key_len);
void  mars_encrypt(const u1byte in_blk[16], u1byte out_blk[16]);
void  mars_decrypt(const u1byte in_blk[16], u1byte out_blk[16]);

void  cast_set_key(const u4byte in_key[], const u4byte key_len);
void  cast_encrypt(const u4byte in_blk[4], u4byte out_blk[]);
