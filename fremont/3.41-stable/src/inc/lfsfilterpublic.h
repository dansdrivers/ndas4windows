...
//	3.20.1508 Release	0x0005
//	3.30.1602 Release	0x0006
//  3.******  Beta		0x0103

#define NDFS_2K_MAJOR_VERSION	((USHORT)0x0003)
#define NDFS_MAJOR_VERSION		((USHORT)0x0006)
//
//	Increase the minor version number whenever NDFS protocol changes.
//
#define NDFS_MINOR_VERSION		((USHORT)0x0001)
