...
#define __NDAS_ROFS__					1
#define __NDAS_ROFS_DISABLE_REINIT__	1
#define __NDAS_ROFS_DISABLE_BUGCHECK__	1

#define __NDAS_ROFS_AVOID_ALYAK_BUG__	1

#if DBG
#define __NDAS_ROFS_DBG__				1
#endif

#define __NDAS_ROFS_WIN2K_SUPPORT__		1
