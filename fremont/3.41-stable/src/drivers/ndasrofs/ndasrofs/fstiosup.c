...
#else
			if (NdasNtfsFsRtlIncrementCcFastReadWait) {
...
#else
			if (NdasNtfsFsRtlIncrementCcFastReadNoWait) {
...
#else
			if (NdasNtfsFsRtlIncrementCcFastReadResourceMiss) {
...
#else
			if (NdasNtfsFsRtlIncrementCcFastReadNotPossible) {
