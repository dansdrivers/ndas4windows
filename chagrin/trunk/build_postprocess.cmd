...
if exist "%BP_PUBDIR%\fre\i386\xixfs"  set DIRS=%DIRS% "%BP_PUBDIR%\fre\i386\xixfs"
if exist "%BP_PUBDIR%\fre\amd64\xixfs" set DIRS=%DIRS% "%BP_PUBDIR%\fre\amd64\xixfs"
if exist "%BP_PUBDIR%\chk\i386\xixfs"  set DIRS=%DIRS% "%BP_PUBDIR%\chk\i386\xixfs"
if exist "%BP_PUBDIR%\chk\amd64\xixfs" set DIRS=%DIRS% "%BP_PUBDIR%\chk\amd64\xixfs"
