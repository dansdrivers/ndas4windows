...
#define NDASSCSI_IOCTL_ADD_TARGET			NDASSCSI_CTL_CODE(0x005)		// adapter
#define NDASSCSI_IOCTL_REMOVE_TARGET		NDASSCSI_CTL_CODE(0x006)		// adapter
...
//#define NDASSCSI_ADAPTERINFO_STATUS_IN_ERROR        0x00000003	// Obsolete
...
//#define NDASSCSI_ADAPTERINFO_STATUSFLAG_DEFECTIVE			0x00004000	// Obsolete
#define NDASSCSI_ADAPTERINFO_STATUSFLAG_POWERRECYCLED		0x00008000
#define NDASSCSI_ADAPTERINFO_STATUSFLAG_RAID_FAILURE		0x00010000
#define NDASSCSI_ADAPTERINFO_STATUSFLAG_RAID_NORMAL			0x00020000
#define NDASSCSI_ADAPTERINFO_STATUSFLAG_RESETSTATUS         0x01000000	// only used for NDASBUS notification
#define NDASSCSI_ADAPTERINFO_STATUSFLAG_NEXT_EVENT_EXIST	0x02000000	// only used for NDASSVC notification
