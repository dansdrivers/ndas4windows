	...
	)
{
	...
	DebugTrace2( 0, Dbg2, ("NdasNtfsPrimarySessionStopping: VolDo = %p\n", VolDo) );
	...
	)
{
	...
	DebugTrace2( 0, Dbg2, ("NdasNtfsPrimarySessionCancelStopping: VolDo = %p\n", VolDo) );
	...
	)
{
	...
	DebugTrace2( 0, Dbg2, ("NdasNtfsPrimarySessionDisconnect: VolDo = %p\n", VolDo) );
	...
	)
{
	...
	DebugTrace2( 0, Dbg2, ("NdasNtfsPrimarySessionSurpriseRemoval: VolDo = %p\n", VolDo) );
	...
	)
{
	...
	if (remaining) {
		...
		NDASFAT_ASSERT( !NT_SUCCESS(status) );
	}
