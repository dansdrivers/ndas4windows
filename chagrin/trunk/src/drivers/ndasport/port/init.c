...
ULONG NdasPortDriverExtensionTag = 1;
...
#if 0
	//
	// In some systems, MmGetSystemRoutineAddress generates an exception
	// due to an uknown reason. We may reinstantiate this when we solve it.
	//
	INIT_DBGPRINTEX();
#endif
	DebugPrint((3, 
    ...
    __in PDRIVER_OBJECT DriverObject)
{
	...
	DebugPrint((3, "NdasPort unloaded successfully.\n"));
