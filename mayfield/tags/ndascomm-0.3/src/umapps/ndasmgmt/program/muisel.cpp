...
NuiGetResLangIDFromFile(LPCTSTR szFilename)
{
	...
	AutoProcessHeap hHeap = lpFileVerData;
	...
	IN OUT PNUI_RESDLL_INFO pRdiList)
{
...
#ifdef UNICODE
	AutoProcessHeap autoModulePath;
	...
	AutoProcessHeap autoModuleDirectory = szModuleDirectory;
	...
	PNUI_RESDLL_INFO pRdiList)
{
	...
	AutoProcessHeap autoHeap = lpBuffer;
