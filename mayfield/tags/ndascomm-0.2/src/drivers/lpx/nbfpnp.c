...
//    PLIST_ENTRY p;
	...
	DebugPrint(3,("NbfProtocolUnbindAdapter ENTER \n"));
...
Out:
	...
	DebugPrint(3,(" !!!!!!!LPX DISABLE NIC CALL %lx\n", DeviceContext));
/*
	// ILGU 2003_1104 support for shutdown NIC
	ACQUIRE_DEVICES_LIST_LOCK();
	...
	RELEASE_DEVICES_LIST_LOCK();
*/
	// ILGU 2003_1103 support for packetDrop
...
#ifdef __LPX__
//@ILGU@ <2003_1120> support device context remove
//		LpxFreeDeviceContext(DeviceContext);
//@ILGU@ <2003_1120> support device context remove
#endif //__LPX__
...
#ifdef __SOCKET_NBF__
#ifdef RASAUTODIAL
        if (InterlockedIncrement(&NumberOfBinds) == 0) {
#else
		{
#endif
#else
...
/*
		NbfDereferenceDeviceContext ("Free DeviceContext", DeviceContext, DCREF_CREATION);
*/
	}
	else {
...
*/
	...
	DebugPrint(3,("NbfProtocolUnbindAdapter END \n"));
    return;
}
