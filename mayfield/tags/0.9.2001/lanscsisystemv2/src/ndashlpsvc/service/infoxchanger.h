...
typedef	union _LSINFOX_RawPktData {
		...
		LSINFOX_NDASDEV_USAGE_REQUEST	UsageRequest;
		LSINFOX_NDASDEV_USAGE_REPLY		UsageReply;

} LSINFOX_DATA, *PLSINFOX_DATA ;

typedef	struct _LSINFOX_Pkt {
	...
	//
	LSINFOX_HEADER		RawHead ;
	LSINFOX_DATA		RawData ;

} LSINFOX_PKT, *PLSINFOX_PKT ;
