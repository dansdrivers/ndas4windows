...
public:
	...
	BEGIN_UPDATE_UI_MAP(CMainFrame)
		...
		UPDATE_ELEMENT(IDM_AGGR_REMIRROR, UPDUI_MENUPOPUP | UPDUI_TOOLBAR)
	...
	BEGIN_MSG_MAP_EX(CMainFrame)
		...
		COMMAND_ID_HANDLER_EX(IDM_AGGR_SYNCHRONIZE, OnSynchronize)
		COMMAND_ID_HANDLER_EX(IDM_AGGR_REMIRROR, OnReestablishMirror)
...
//	LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	void OnSynchronize(UINT wNotifyCode, int wID, HWND hwndCtl);
	void OnReestablishMirror(UINT wNotifyCode, int wID, HWND hwndCtl);
