...
!ifndef NDAS_SOURCE_TREE
NDAS_SOURCE_TREE=lanscsisystemv2
!endif

!ifndef NDAS_ROOT
!if exists(.\$(NDAS_SOURCE_TREE))
NDAS_ROOT=.\$(NDAS_SOURCE_TREE)
!elseif exists(..\$(NDAS_SOURCE_TREE))
NDAS_ROOT=.
!elseif exists(..\..\$(NDAS_SOURCE_TREE))
NDAS_ROOT=..
!elseif exists(..\..\..\$(NDAS_SOURCE_TREE))
...
NDAS_ROOT=..\..\..\..\..\..\..\..\..
!else
!error NDAS Source Tree $(NDAS_SOURCE_TREE) cannot be found!
!endif
!endif
