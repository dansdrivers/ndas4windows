...
typedef struct _LSTRANS_ADDRESS_LIST {
    LONG			iAddressCount;
    SOCKADDR_LPX	TransAddrList[MAX_LSTRANS_NETWORK_INTERFACE];
} LSTRANS_ADDRESS_LIST, *PLSTRANS_ADDRESS_LIST;
*/
...
typedef NTSTATUS (*LSTRANS_CONNECT_FUNC)(
		IN	PFILE_OBJECT		ConnectionFileObject,
		IN	PTA_LSTRANS_ADDRESS	lpxAddress
	) ;
