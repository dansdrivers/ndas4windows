...
//#define IOCTL_SIGNATURE						LANSCSIMINIPORT_IOCTL_SIGNATURE
...
#define ADAPTERINFO_STATUSFLAG_STOP_PENDING			0x00000400
...
/*
//
//	UnitDisk information
//
typedef struct _LSMPIoctl_UnitDiskInfo {
	...
	UINT32					UnitDiskCount ;
	LSMP_UNITDISK			UnitDisks[1] ;

}	LSMPIOCTL_UNITDISKINFO, *PLSMPIOCTL_UNITDISKINFO ;
