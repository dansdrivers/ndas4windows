...
#define NDAS_UNITDEVICE_DISK_TYPE_RAID_1		0xF000
...
#ifdef __cplusplus
__inline bool IsNullNdasLogicalDeviceId(const NDAS_LOGICALDEVICE_ID& logDevId)
#else
__inline BOOL IsNullNdasLogicalDeviceId(NDAS_LOGICALDEVICE_ID logDevId)
#endif
{
	return (0 == logDevId.SlotNo &&
		0 == logDevId.LUN && 
		0 == logDevId.TargetId);
}

/* NULL value function for NDAS Logical Device ID */

#ifdef __cplusplus
__inline const NDAS_LOGICALDEVICE_ID& NullNdasLogicalDeviceId(void)
#else
__inline NDAS_LOGICALDEVICE_ID NullNdasLogicalDeviceId()
#endif
{
	static const NDAS_LOGICALDEVICE_ID NullLogicalDeviceId = {0};
	return NullLogicalDeviceId;
}
...
#define NDAS_LOGICALDEVICE_TYPE_DISK_RAID_1     0x0015
...
/* NDAS Unit Device Usage Statistics */

typedef struct _NDAS_UNITDEVICE_USAGE_STATS
{
	DWORD nROHosts;
	DWORD nRWHosts;
	BYTE  Reserved[32 - sizeof(DWORD)*2];
} NDAS_UNITDEVICE_USAGE_STATS, *PNDAS_UNITDEVICE_USAGE_STATS;
