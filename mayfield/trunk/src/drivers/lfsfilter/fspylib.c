...
--*/
{
	...
	
	{
		...
		ntStatus = LfsAttachToFileSystemDevice (
								DeviceObject,
								filespyDeviceObject,
								DeviceName
								);
...
#ifdef __LFS__
									{
										// If device object deleted before LfsAttachToMountedDeviceWorker start,
										// LFS will be failed

										LfsAttachToMountedDevice(
											FileSpyFsDeviceObject,
											devList[i],
											newDeviceObject
											);
