...

{
	...
	if (providerDeviceContext == NULL) {
		...
		DebugPrint(1, ("[Lpx] NbfOpenAddress: couldn't find providerDeviceContext\n") );
		return	status;
	}

	DebugPrint( 2, ("[Lpx] NbfOpenAddress: DeviceContext is changed into providerDeviceContext\n") );
