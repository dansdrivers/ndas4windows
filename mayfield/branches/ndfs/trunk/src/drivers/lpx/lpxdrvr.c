...
#if (defined __LPX__ && defined __LPX_MUTEX_SPIN_LOCK__)
...

{
	...
	NbfDebug |= LPX_DEBUG_ERROR;
	NbfDebug |= LPX_DEBUG_CURRENT_IRQL;
	//NbfDebug |= NBF_DEBUG_TEARDOWN;
	NbfDebug |= LPX_DEBUG_TEMP;
	...
	SocketNbfProtocolBindAdapter( NULL,
								  NULL,
								  NULL,
								  NULL,
								  NULL );
...
*/
	...
	if (SocketLpxDeviceContext) {
		...
		SocketNbfProtocolUnbindAdapter( &ndisStatus,
