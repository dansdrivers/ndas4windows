...
#define NDSC_DEFAULT_MAXREQUESTBLOCKS	512
...
//	Pool tags
//
#define	LSMP_PTAG_IOCTL		'oiSN'
#define LSMP_PTAG_WORKITEM	'cwSN'
#define LSMP_PTAG_SRB		'rsSN'
#define LSMP_PTAG_CMPDATA	'mcSN'
#define LSMP_PTAG_ENUMINFO	'neSN'
...
typedef struct _MINIPORT_DEVICE_EXTENSION {
	...
	ULONG			AdapterMaxBlocksPerRequest;
	...
	BOOLEAN			LURSavedSecondaryFeature[NR_MAX_LANSCSIMINIPORT_LURS];
