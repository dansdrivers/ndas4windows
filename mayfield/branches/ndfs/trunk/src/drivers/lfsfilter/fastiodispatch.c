	...
	)
{
	...
	SPY_LOG_PRINT( LFS_DEBUG_LFS_TRACE, ("LfsFastIoDetachDevice entered\n")) ;
	...
	)
{
	...
	fastIoDispatch = ExAllocatePoolWithTag( NonPagedPool, sizeof(FAST_IO_DISPATCH), LFS_ALLOC_TAG );
	...
	)
{
	if (LfsFastIoDispatch)
		ExFreePoolWithTag( LfsFastIoDispatch, LFS_ALLOC_TAG );
