...
#define DRVO_BASE_FILESYSTEM_DRIVER	0x00000080   // A driver that is at the bottom of the filesystem stack.
	...
	if ((PVOID)FatControlDeviceObject == VolumeDeviceObject) {
		...
		if (irpSp->Parameters.FileSystemControl.FsControlCode == ND_FAT_SHUTDOWN) {

			DebugTrace2( 0, Dbg, ("IoControlCode == ND_FAT_SHUTDOWN occured DeviceObject->ReferenceCount = %x\n", 
...
#ifndef __ND_FAT_PURGE_OR_FLUSH__
