...
#define ND_FAT_IRP_CONTEXT_FLAG_SECONDARY_FILE						0x00000001
#define ND_FAT_IRP_CONTEXT_FLAG_SECONDARY_CREATE_FILE				0x00000002
#define ND_FAT_IRP_CONTEXT_FLAG_ALREADY_COMPLETED					0x00000008

#define ND_FAT_IRP_CONTEXT_FLAG_TRY_CLOSE_FILES						0x00000010

#define ND_FAT_IRP_CONTEXT_FLAG_FLUSH								0x00000100
#define ND_FAT_IRP_CONTEXT_FLAG_PURGE								0x00000200
