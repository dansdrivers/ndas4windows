...

{
    ...
    DebugTrace(+1, Dbg, "FatFsdPnp, MinorFunction = %d\n", IoGetCurrentIrpStackLocation( Irp )->MinorFunction);
	...
	DebugTrace2( -1, Dbg, ("FatFsdPnp -> %08lx, VolumeDeviceObject->ReferenceCount = %x\n", Status, VolumeDeviceObject->ReferenceCount) );
