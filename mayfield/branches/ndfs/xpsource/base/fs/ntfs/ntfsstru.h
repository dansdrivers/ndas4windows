...
#define ND_NTFS_DEVICE_FLAG_SHUTDOWN		0x00000004
	...
	LIST_ENTRY						PrimarySessionQueue;			// Mounted Device Lfs Primary Device Extension Queue
...
#ifdef __ND_NTFS_DIRECT_READWRITE__
...
typedef struct _PRIMARY_REQUEST_INFO {
	...
	ULONG								PrimaryTag;
	struct _PRIMARY_SESSION				*PrimarySession;
	struct _NDFS_WINXP_REQUEST_HEADER	*NdfsWinxpRequestHeader;
