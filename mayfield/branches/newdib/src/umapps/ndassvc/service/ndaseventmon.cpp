...
static ULONG 
pGetSignificatAlarm(ULONG ulOldStatus, ULONG ulNewStatus);
...
pGetSignificatAlarm(ULONG ulOldStatus, ULONG ulNewStatus)
{
	if(IS_TURNED_ON(NDAS_DEVICE_ALARM_STATUSFLAG_RECOVERING, ulOldStatus, ulNewStatus))
		return NDAS_DEVICE_ALARM_RECOVERING;
	else if(IS_TURNED_ON(NDAS_DEVICE_ALARM_STATUSFLAG_MEMBER_FAULT, ulOldStatus, ulNewStatus))
		return NDAS_DEVICE_ALARM_MEMBER_FAULT;
	else if(IS_TURNED_ON(NDAS_DEVICE_ALARM_STATUSFLAG_RECONNECT_PENDING, ulOldStatus, ulNewStatus))
		return NDAS_DEVICE_ALARM_RECONNECTIONG;
	else if(IS_TURNED_OFF(NDAS_DEVICE_ALARM_STATUSFLAG_RECOVERING, ulOldStatus, ulNewStatus) &&
	...
	else if(IS_TURNED_OFF(NDAS_DEVICE_ALARM_STATUSFLAG_RECONNECT_PENDING, ulOldStatus, ulNewStatus) &&
