...
public:
	...
	//
	CNdasLogicalDevice* Register(CNdasUnitDevice& unitDevice);
...
//	ConstIterator end();
	...
	void GetItems(CNdasLogicalDeviceCollection& coll);

	VOID OnShutdown();

protected:
	static void ShutdownOf(const LDIDMap::value_type& pair);
};
