...
#define LSP_HW_VERSION_2_0			2 // frame.vhd : cHW_VERSION, cVERSION_ACTIVE
#define LSP_HW_VERSION_2_5			3 // frame.vhd : cHW_VERSION, cVERSION_ACTIVE
#define LSP_HW_VERSION_MAX			LSP_HW_VERSION_2_5 // frame.vhd : cVERSION_MAX
