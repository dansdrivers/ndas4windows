...
//	LIST_ENTRY				StoppedVolumeQueue;			// Stoped Lfs Primary Device Extension Queue. Not used
//	KSPIN_LOCK				StoppedVolumeQSpinLock;		// Not used.
	...
	//
	//	LFS event queue manager
	//

	XEVENT_QUEUE_MANAGER	EvtQueueMgr;

	FAST_MUTEX				PurgeFastMutex; // Currently not used.
...
typedef struct _LFS_DEVICE_EXTENSION
{
	...
	LIST_ENTRY					PrimaryQListEntry; // not used?
