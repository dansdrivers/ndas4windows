...
typedef enum _SPY_DEBUG_FLAGS {
    ...
    SPYDEBUG_TRACE_CONTEXT_OPS              = 0x00000010,
    SPYDEBUG_TRACE_DETAILED_CONTEXT_OPS     = 0x00000020,
    SPYDEBUG_TRACE_MISMATCHED_NAMES         = 0x00000040,
    SPYDEBUG_ASSERT_MISMATCHED_NAMES        = 0x00000080,
