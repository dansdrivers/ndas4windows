...
#define NUMBER_OF_PACKET_MEM_LOOKASIDE_LIST 4
#define LOOK_ASIDE_PACKET_MEM_SIZES {64, 600, 1600, 8200}
...
typedef struct _DEVICE_CONTEXT {
	...
	NPAGED_LOOKASIDE_LIST PacketMemLookAsideList[NUMBER_OF_PACKET_MEM_LOOKASIDE_LIST]; // ~64, ~600, ~1600, ~8200
#endif
    ...
    ULONG MaxUserData;					// Max data length excluding lpx header
    ULONG MaxJumboUserData;				// Max data length excluding lpx header that can be used for sending jumbo packet
    									// 0 if this interface does not support jumbo packet
