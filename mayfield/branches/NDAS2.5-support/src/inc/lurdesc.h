...
#define LURN_REDUNDENT_TYPE(type) (type == LURN_RAID1R || type == LURN_RAID4R)
...
#define	LUROPTION_OFF_NDAS_2_0_WRITE_CHECK	0x00002000	// Turn off the write-check for NDAS 2.0. 
#define	LUROPTION_ON_DYNAMIC_REQUEST_SIZE	0x00004000	// Turn On dynamic request size. Default on.
#define	LUROPTION_OFF_DYNAMIC_REQUEST_SIZE	0x00008000	// Turn off dynamic request size. Always use max request size.
