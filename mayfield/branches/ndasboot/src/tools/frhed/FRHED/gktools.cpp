...
NDAS_CONNECTION_INFO NdasConnectionInfo;
...
//					switch(GetWindowTextLength(hEditID))
					...
					{
					case 12:
						NdasConnectionInfo.type = NDAS_CONNECTION_INFO_TYPE_MAC_ADDRESS;
						STR_TO_MAC(i, NdasConnectionInfo.MacAddress, buf, 2);
						break;
					case 17:
						NdasConnectionInfo.type = NDAS_CONNECTION_INFO_TYPE_MAC_ADDRESS;
						STR_TO_MAC(i, NdasConnectionInfo.MacAddress, buf, 3);
						break;
					case 20:
						...
						NdasConnectionInfo.type = NDAS_CONNECTION_INFO_TYPE_IDA;
						CopyMemory(NdasConnectionInfo.szDeviceStringId, buf, 20);
						break;
					case 23:
						if(NdasConnectionInfo.bWriteAccess)
						{
						...
						NdasConnectionInfo.type = NDAS_CONNECTION_INFO_TYPE_IDA;
						CopyMemory(NdasConnectionInfo.szDeviceStringId, buf, 5);
						CopyMemory(NdasConnectionInfo.szDeviceStringId +5, buf +6, 5);
						CopyMemory(NdasConnectionInfo.szDeviceStringId +10, buf +12, 5);
						CopyMemory(NdasConnectionInfo.szDeviceStringId +15, buf +18, 5);
						break;
					case 25:
						NdasConnectionInfo.type = NDAS_CONNECTION_INFO_TYPE_IDA;
						CopyMemory(NdasConnectionInfo.szDeviceStringId, buf, 25);
						break;
					case 29:
						NdasConnectionInfo.type = NDAS_CONNECTION_INFO_TYPE_IDA;
						CopyMemory(NdasConnectionInfo.szDeviceStringId, buf, 5);
						...
						CopyMemory(NdasConnectionInfo.szDeviceStringId +10, buf +12, 5);
						CopyMemory(NdasConnectionInfo.szDeviceStringId +15, buf +18, 5);
						CopyMemory(NdasConnectionInfo.szDeviceStringKey, buf +24, 5);
						break;
					default:
					...
					NdasConnectionInfo.protocol = IPPROTO_LPXTCP;
