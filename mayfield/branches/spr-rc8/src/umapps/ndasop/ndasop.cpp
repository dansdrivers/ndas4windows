...
*/
	...
	TEST_AND_GOTO_WITH_ERROR_IF_FAIL(NDASOP_ERROR_NOT_ENOUGH_MEMORY, out, BufferRecover2);
...
)
{
	...
	unit_recover_info = (DIB_V2.nDiskCount -1 == i) ? 0 : i +1;
