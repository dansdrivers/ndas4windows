	...
	ULONG AdapterStatus)
{
	...
	if(NDAS_DEVICE_ALARM_STATUSFLAG_RECOVERING & AdapterStatus)
	{
		strInfoFmt.LoadString(IDS_BT_RECOVERING_INFO);
	}
	else if(NDAS_DEVICE_ALARM_STATUSFLAG_MEMBER_FAULT & AdapterStatus)
	{
		strInfoFmt.LoadString(IDS_BT_EMERGENCY_INFO);
	}
	else if(NDAS_DEVICE_ALARM_STATUSFLAG_RECONNECT_PENDING & AdapterStatus)
	{
