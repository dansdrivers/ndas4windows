# Microsoft Developer Studio Project File - Name="WanscsiOpLib" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "WanScsiOpLib.mak".
!MESSAGE 
...
SOURCE="$(InputPath)"
PostBuild_Cmds=..\..\bin\libplace.cmd Release $(TargetPath)
...
SOURCE="$(InputPath)"
PostBuild_Cmds=..\..\bin\libplace.cmd Debug $(TargetPath)
# End Special Build Tool
...
# Name "WanscsiOpLib - Win32 Release"
# Name "WanscsiOpLib - Win32 Debug"
