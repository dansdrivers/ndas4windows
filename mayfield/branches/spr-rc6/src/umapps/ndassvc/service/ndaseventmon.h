...
{
	typedef std::set<CNdasDevice*> CNdasDeviceSet;
	typedef std::vector<CNdasLogicalDevice*> CNdasLogicalDeviceVector;

	CNdasDeviceSet m_hbMonDevices;
	CNdasLogicalDeviceVector m_vLogDevices;
