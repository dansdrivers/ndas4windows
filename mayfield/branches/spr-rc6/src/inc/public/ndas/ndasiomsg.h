...
//
// MessageId: NDASSCSI_IO_LUR_CREATION_FAIL
//
// MessageText:
//
//  %1 device(%2) could not create an logical unit.
//
#define NDASSCSI_IO_LUR_CREATION_FAIL    ((NTSTATUS)0xEE01010DL)
...
//
// MessageId: NDASSCSI_IO_STOPREQ_WHILE_POWERSAVING
//
// MessageText:
//
//  %1 device(%2) received stop request while entering power-saving mode.
//
#define NDASSCSI_IO_STOPREQ_WHILE_POWERSAVING ((NTSTATUS)0xAE010117L)

//
// MessageId: NDASSCSI_IO_INQUIRY_WHILE_POWERSAVING
//
// MessageText:
//
//  %1 device(%2) received inquiry request while entering power-saving mode.
//
#define NDASSCSI_IO_INQUIRY_WHILE_POWERSAVING ((NTSTATUS)0xAE010118L)
...
//
// MessageId: NDASSCSI_IO_DOUBLE_ENTER_POWERSAVING
//
// MessageText:
//
//  %1 device(%2) was requested to enter power saving mode again.
//
#define NDASSCSI_IO_DOUBLE_ENTER_POWERSAVING ((NTSTATUS)0xAE01011BL)

//
// MessageId: NDASSCSI_IO_DOUBLE_EXIT_POWERSAVING
//
// MessageText:
//
//  %1 device(%2) was requested to exit from power saving mode again.
//
#define NDASSCSI_IO_DOUBLE_EXIT_POWERSAVING ((NTSTATUS)0xAE01011CL)

//
// MessageId: NDASSCSI_IO_SCSIOP_WHILE_POWERSAVING
//
// MessageText:
//
//  %1 device(%2) received SCSI request request while entering power-saving mode.
//
#define NDASSCSI_IO_SCSIOP_WHILE_POWERSAVING ((NTSTATUS)0xAE01011DL)
