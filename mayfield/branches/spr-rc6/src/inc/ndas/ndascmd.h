...
//#define	NDAS_CMD_TYPE_RECOVER_LOGICALDEVICE				0x44		// Obsolete
...
struct NDAS_CMD_SET_DEVICE_PARAM_DATA {
...
struct NDAS_CMD_SET_UNITDEVICE_PARAM_DATA {
...
struct NDAS_CMD_SET_LOGICALDEVICE_PARAM_DATA {
...
struct NDAS_CMD_LOGICALDEVICE_DISK_INFORMATION {
	DWORD Blocks;
	BYTE Reserved[24];
};
