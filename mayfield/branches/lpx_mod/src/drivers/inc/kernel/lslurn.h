...
//
#define MAX_RECONNECTION_INTERVAL	(NANO100_PER_SEC*3)
...
typedef struct _LURELATION LURELATION, *PLURELATION ;
typedef struct _RAID0_INFO RAID0_INFO, *PRAID0_INFO ;
typedef struct _RAID1_INFO RAID1_INFO, *PRAID1_INFO ;
typedef struct _RAID4_INFO RAID4_INFO, *PRAID4_INFO ;
...
typedef struct _LURELATION_NODE {
	...
	union{
		PVOID				LurnExtension;
		PRAID0_INFO			LurnRAID0Info;
		PRAID1_INFO			LurnRAID1Info;
		PRAID4_INFO			LurnRAID4Info;
	};
