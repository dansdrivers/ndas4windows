...
//#endif
		...
		for(idx_childlurn = 0; idx_childlurn < nMirrorDisks; idx_childlurn++ )
		{
			...
			RtlCopyMemory(&cur_lurn->LurnInfoRAID1[0], &AddTargetData->UnitDiskList[idx_childlurn *2].RAID1, sizeof(INFO_RAID1));
			RtlCopyMemory(&cur_lurn->LurnInfoRAID1[1], &AddTargetData->UnitDiskList[idx_childlurn *2 +1].RAID1, sizeof(INFO_RAID1));
	...
	case DISK_TYPE_BIND_RAID4:
	{
		...
		for(idx_childlurn = 0; idx_childlurn < ChildLurnCnt; idx_childlurn++)
		{
			...
			RtlCopyMemory(&RootNode->LurnInfoRAID4[idx_childlurn], &AddTargetData->UnitDiskList[idx_childlurn].RAID4, sizeof(INFO_RAID4));
		}
