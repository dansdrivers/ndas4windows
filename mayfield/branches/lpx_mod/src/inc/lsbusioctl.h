...
#define IOCTL_LANSCSI_QUERY_REGISTER				BUSENUM_IOCTL	(0x45)
...
typedef struct _LANSCSI_REGISTER_NDASDEV
{
	ULONG			SlotNo;
	ULONG			PluginTime;
	ULONG			Flags;
	...
	WCHAR			HardwareIDs[LSREGISTER_MAX_HARDWAREIDS_LENGTH];
	ULONG			LurDescLength;
	LURELATION_DESC	LurDesc;

} LANSCSI_REGISTER_NDASDEV, *PLANSCSI_REGISTER_NDASDEV;
