...
BOOL CBindPage2::OnWizardFinish()
{
	...
	pConnectionInfo = new NDAS_CONNECTION_INFO[vtBind.size()];
	ZeroMemory(pConnectionInfo, sizeof(NDAS_CONNECTION_INFO) * vtBind.size());
