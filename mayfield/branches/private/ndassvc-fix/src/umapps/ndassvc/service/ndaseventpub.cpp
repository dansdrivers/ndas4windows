...
CNdasEventPublisher::CNdasEventPublisher() :
	m_hSemQueue(NULL),
	m_dwPeriod(NdasServiceConfig::Get(nscPeriodicEventInterval)),
...
//	msg.DeviceEventInfo.DeviceId = deviceId;
	...
	DBGPRT_INFO(_FT("Device (%d) Status Changed: %s -> %s.\n"),
		slotNo, 
	...
	DWORD slotNo, DWORD unitNo)
{
	...
	DBGPRT_INFO(_FT("Unit Device (%d, %d) Property Changed.\n"), slotNo, unitNo);
	...
	NDAS_LOGICALDEVICE_STATUS newStatus)
{
	...
	DBGPRT_INFO(_FT("Logical Device (%d) Status Changed: %s -> %s.\n"),
		logicalDeviceId,
	...
	NDAS_LOGICALDEVICE_ID logicalDeviceId)
{
	...
	DBGPRT_INFO(_FT("Logical Device (%d) Property Changed.\n"), logicalDeviceId);
	...
	NDAS_LOGICALDEVICE_ID logicalDeviceId)
{
	...
	DBGPRT_INFO(_FT("Logical Device (%d) is disconnected.\n"), logicalDeviceId);
...
//	msg.LogicalDeviceEventInfo.LogicalDeviceId = logicalDeviceId;
//
//	DBGPRT_INFO(_FT("Logical Device (%d) is being reconnected.\n"), logicalDeviceId);
//
//	return AddEvent(msg);
//}
	...
	ULONG ulStatus)
{
	...
	DBGPRT_INFO(_FT("Logical Device (%d) has adapter status %08lx.\n"), 
