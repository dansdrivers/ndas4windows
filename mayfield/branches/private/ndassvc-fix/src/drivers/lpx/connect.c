...

{
    ...
    if (!NT_SUCCESS (status)) {
        DebugPrint(1, ("NbfOpenConnection: error NbfCreateConnection\n") );
...
//	DebugPrint(2, ("NumberOfConn %lx\n",NumberOfConn));
	InterlockedIncrement(&NumberOfConn);
...
//        NbfPrint1 ("[LPX] NbfCloseConnection: CO %lx:\n",connection);
//    }
