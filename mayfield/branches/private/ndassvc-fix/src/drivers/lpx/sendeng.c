...
//    KIRQL			lpxOldIrql;
	...
	// hootch 08262003
//    ACQUIRE_SPIN_LOCK (&SocketLpxDeviceContext->SpinLock, &lpxOldIrql);
...
//  RELEASE_SPIN_LOCK (&SocketLpxDeviceContext->SpinLock, lpxOldIrql);
    ...
    if (Link->Provider->UniProcessor) {
        ...
        switch (NdisStatus) {
            ...
            case NDIS_STATUS_SUCCESS:
				...
				DbgPrint ("NbfNdisSend: bfSendCompletionHandler Called NDIS_STATUS_SUCCESS. UniProcessor \n");
...
#endif
				DbgPrint ("NbfNdisSend: bfSendCompletionHandler Called. default. UniProcessor\n");
        ...
        while (TRUE) {
            ...
            switch (NdisStatus) {
                ...
                case NDIS_STATUS_SUCCESS:
                    ...
                    NbfSendsCompletedOk++;
#endif
					DbgPrint ("NbfNdisSend: bfSendCompletionHandler Called. NDIS_STATUS_SUCCESS. No UNiPRO.\n");
                ...
                default:
                    ...
                    NbfSendsCompletedFail++;
#endif
					DbgPrint ("NbfNdisSend: bfSendCompletionHandler Called. defult. No UNiPRO.\n");
