...
namespace ndas
{
	namespace settings
	{
		DWORD AddTargetGap::Value()	{ return 500; }
		DWORD PlugInFailToEjectGap::Value()  { return 500; }
		DWORD MaxHeartbeatFailure::Value()
		{
			return ndascfg::sys::MaxHeartbeatFailureDef::GetValue();
		}
		DWORD MaxUnitDeviceIdentifyFailure::Value()
		{
			return ndascfg::sys::MaxUnitDeviceIdentifyFailureDef::GetValue();
		}
	}
}
