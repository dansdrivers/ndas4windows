...
#if DBG
#ifdef __SOCKET_NBF__
	DbgPrint("LPX DriverEntry %s %s\n", __DATE__, __TIME__);
	NbfDebug = 0;

//	NbfDebug |= NBF_DEBUG_DISPATCH;
	NbfDebug |= NBF_DEBUG_PNP;
//	NbfDebug |= NBF_DEBUG_ADDRESS ;
//	NbfDebug |= NBF_DEBUG_REFCOUNTS;
//	NbfDebug |= NBF_DEBUG_DISPATCH;
//	NbfDebug = 0xFFFFFFFF;
//	NbfDebug &= ~NBF_DEBUG_TIMERDPC;
#endif
...
*/
	...
	DebugPrint(3,(" !!!!!! CALL NBF UNLOAD END!!!\n"));
    return;
}
...
--*/
{
    ...
    PBUFFER_Told us about its max header size. TP_PACKETs are used
    ...
    RtlCopyMemory(NetBIOSAddress->NetbiosName,
                  Devicure status information is consistent every time.
    //
    ...
    case IRP_MJ_CREATE:
        ...
        if (openType != NULL) {
            ...
            if (found) {
				DebugPrint(2,("LPX CALL NbfOpenAddress\n"));
            ...
            if (found) {
				DebugPrint(2,("LPX CALL NbfOpenConnection\n"));
    ...
    case IRP_MJ_CLOSE:
        ...
        case TDI_TRANSPORT_ADDRESS_FILE:
            ...
            if (!NT_SUCCESS (Status)) {
				...
				DebugPrint(2,("LPX CALL NbfCloseAddress\n"));
        ...
        case TDI_CONNECTION_FILE:
            ...
            if (NT_SUCCESS (Status)) {
				DebugPrint(3,("LPX CALL NbfCloseConnection\n"));
...

{
    ...
    switch (IrpSp->Parameters.DeviceIoControl.IoControlCode) {
		...
		case IOCTL_TCP_QUERY_INFORMATION_EX:
		{
            ...
            DebugPrint(3, ("NBF: IOCTL_TCP_QUERY_INFORMATION_EX, outputBufferLength= %d, outputBuffer = %p\n", 
				outputBufferLength, outputBuffer));
		...
		case IOCTL_TCP_SET_INFORMATION_EX:
			{
				...
				DebugPrint(1, ("[LPX]Here\n"));
				
				//
				// Now fill in the NDIS_REQUEST.
				//
				NbfDataBuffer = (NDIS_PACKET_TYPE_DIRECTED | NDIS_PACKET_TYPE_BROADCAST);
				...
				if (NdisStatus == NDIS_STATUS_PENDING) {
					...
					IF_NBFDBG (NBF_DEBUG_NDIS) {
						NbfPrint1 ("OID %lx pended.\n",
							NbfRequest.DATA.QUERY_INFORMATION.Oid);
					}
				...
				if (NdisStatus == STATUS_SUCCESS) {
					...
					IF_NBFDBG (NBF_DEBUG_NDIS) {
						if (NbfRequest.RequestType == NdisRequestSetInformation) {
							NbfPrint1 ("Nbfdrvr: Set OID %lx succeeded.\n",
								NbfRequest.DATA.SET_INFORMATION.Oid);
						} else {
					...
					if (NbfRequest.RequestType == NdisRequestSetInformation) {
						NbfPrint2 ("Nbfdrvr: Set OID %lx failed: %s.\n",
							NbfRequest.DATA.SET_INFORMATION.Oid, NbfGetNdisStatus(NdisStatus));
					} else {
						NbfPrint2 ("Nbfdrvr: Query OID %lx failed: %s.\n",
							NbfRequest.DATA.QUERY_INFORMATION.Oid, NbfGetNdisStatus(NdisStatus));
					}
#endif
				}
		...
		case IOCTL_LPX_GET_DROP_RATE:
			{
				...
				*pulData = ulPacketDropRate;

				DebugPrint(1, ("[LPX]IOCTL_LPX_GET_DROP_RATE: %d\n", *pulData));
		...
		case IOCTL_LPX_SET_DROP_RATE:
			{
				...
				DebugPrint(1, ("[LPX]IOCTL_LPX_SET_DROP_RATE: %d -> %d\n", ulPacketDropRate, *pulData));
...

{
    ...
    switch (IrpSp->MinorFunction) {
        ...
        case TDI_ASSOCIATE_ADDRESS:
			...
			DebugPrint(2,("NbfDispatchInternal: NbfTdiAssociateAddress request.\n"));
        ...
        case TDI_DISASSOCIATE_ADDRESS:
			...
			DebugPrint(3,("NbfDispatchInternal: NbfTdiDisassociateAddress request.\n"));
...
#endif // hexwnd_h                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 è  &        (    (       @                                  €  €   €€ €   € € €€  ÀÀÀ €€€   ÿ  ÿ   ÿÿ ÿ   ÿ ÿ ÿÿ  ÿÿÿ                                                                                                                                                                                                       ""          * ¢ªª¢¢¢      * ¢¢""¢¢      *""¢¢" **       *ªª¢ªª ¢       *""¢¢" **       * ¢¢""¢¢      * ¢ªª¢¢¢         ""                                                                                                                                                                                       ÿÿÿÿÿÿÿÿÿÿÿóÿÿÿãÿðÇÿñÿþüÿÿ?ûÿÿß÷ÿÿï÷ÿÿïïÿÿ÷îôwÜ`;Ü`;Ü 0{Ü ûÜ 0{Ü`;Ü`;Þô{ïÿÿ÷ïÿÿ÷÷ÿÿï÷ÿÿïûÿÿßüÿÿ?ÿþÿÿñÿÿðÿÿÿÿÿÿÿÿÿ(                €                         €  €   €€ €   € € €€  ÀÀÀ €€€   ÿ  ÿ   ÿÿ ÿ   ÿ ÿ ÿÿ  ÿÿÿ                                   """    ¢ª"    ¢¢¢¢¢  ¢¢¢"¢  ¢¢¢"*  ª¢ª"*  ¢¢¢"¢  ¢¢¢"¢   ¢¢¢¢¢   "ª"     """           ÿÿ  ÿÿ  ÿù  ð3  à  À  €                 €  À  à  ð?                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            #include "precomp.h"
#include "ido.h"
#include "hexwnd.h"
#include <shlwapi.h>
...
STDMETHODIMP CDataObject::QueryGetData( FORMATETC* pFormatetc )
{
	...
	return DV_E_FORMATETCeContext->ReservedNetBIOSAddress, 16);
