...
Abstract:
    ...
    This contains internal definitions from the fileSpy lfsfiltlibrary

Environment:

    LfsFiltLibrary used by both USER and KERNEL mode components

--*/

#ifndef __FILESPYLFSFILTLIB_H__
#define __FILESPYLFSFILTLIB_H__
