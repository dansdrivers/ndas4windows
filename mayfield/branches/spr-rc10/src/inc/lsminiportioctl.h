...
//#define LANSCSIMINIPORT_IOCTL_RECOVER_TARGET		LSMP_CTL_CODE(0x00B)		// Obsolete
#define LANSCSIMINIPORT_IOCTL_DELAYEDOP				LSMP_CTL_CODE(0x00C)
...
#define ADAPTERINFO_STATUSFLAG_RECOVERING			0x00001000
#define ADAPTERINFO_STATUSFLAG_ABNORMAL_TERMINAT	0x00002000
