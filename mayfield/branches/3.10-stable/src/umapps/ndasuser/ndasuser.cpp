...
//	lpReply->LogicalDiskInfo.LogicalDiskType;
	...
	if (IS_NDAS_LOGICALDEVICE_TYPE_DISK_GROUP(pLogDevInfo->LogicalDeviceType)) {
		pLogDevInfo->LogicalDiskInformation.Blocks = 
			lpReply->LogicalDiskInfo.Blocks;
		pLogDevInfo->LogicalDiskInformation.ContentEncrypt.Revision = 
			lpReply->LogicalDiskInfo.ContentEncrypt.Revision;
		pLogDevInfo->LogicalDiskInformation.ContentEncrypt.Type = 
			lpReply->LogicalDiskInfo.ContentEncrypt.Type;
		pLogDevInfo->LogicalDiskInformation.ContentEncrypt.KeyLength = 
			lpReply->LogicalDiskInfo.ContentEncrypt.KeyLength;
