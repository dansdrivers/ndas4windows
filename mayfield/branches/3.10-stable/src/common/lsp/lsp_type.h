...
#define LSP_ERR_COMPOSITE		((ERR) & 0xffff0000)
#define LSP_ERR_FUNC(ERR)		((ERR) & 0xffff0000 >> 16)
#define LSP_ERR_PHASE(ERR)		(((ERR) & 0xf000) >> 12)
#define LSP_ERR_TYPE(ERR)		(((ERR) & 0x0f00) >> 8)
#define LSP_ERR_RESPONSE(ERR)	(((ERR) & 0x00ff) >> 0)

#define LSP_ERR_FUNC_NOOP				0x00
#define LSP_ERR_FUNC_LOGIN				0x01
#define LSP_ERR_FUNC_LOGOUT				0x02
#define LSP_ERR_FUNC_TEXT_COMMAND		0x03
#define LSP_ERR_FUNC_TASK_MGMT_COMMAND	0x04
#define LSP_ERR_FUNC_SCSI_COMMAND		0x05
#define LSP_ERR_FUNC_DATA_COMMAND		0x06
#define LSP_ERR_FUNC_IDE_COMMAND		0x08
#define LSP_ERR_FUNC_VENDOR_COMMAND		0x0F

#define LSP_ERR_FUNC_SEND_PDU			0x80
#define LSP_ERR_FUNC_RECV_PDU			0x81
