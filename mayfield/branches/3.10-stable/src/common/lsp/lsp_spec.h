...
/* Vendor commands */
#define LSP_VCMD_SET_MAX_RET_TIME               0x01
...
#define LSP_VCMD_SET_DYNAMIC_MAX_RET_TIME       0x09
#define LSP_VCMD_SET_DYNAMIC_MAX_CONN_TIME      0x0A
#define LSP_VCMD_GET_MAX_RET_TIME               0x03
