...
extern DWORD _DbgPrintLevel = DBGPRN_DEFAULT_LEVEL;
extern DWORD _DbgPrintErrorLevel = DBGPRN_ERROR_LEVEL;
#else // DBGPRN_EXTERN_LEVEL
static DWORD _DbgPrintLevel;
static DWORD _DbgPrintErrorLevel;
...
DBGPRNAPI _DbgVPrintErrA(DWORD ErrorCode, LPCSTR Format, va_list ap)
{
	...
	DWORD_PTR cchRemaining = DBGPRN_MAX_CHARS;
	DWORD cch = 0;
	HRESULT hr;
