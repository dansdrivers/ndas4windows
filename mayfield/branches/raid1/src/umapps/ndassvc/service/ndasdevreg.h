...
public:
	...
	//
	PCNdasDevice Register(const NDAS_DEVICE_ID& DeviceId);
	...
	// Call GetLastError for an extended information.
	//
	PCNdasDevice Register(const NDAS_DEVICE_ID& DeviceId, DWORD dwSlotNo);
	...
	// 
	PCNdasDevice Find(const NDAS_DEVICE_ID& DeviceId);
