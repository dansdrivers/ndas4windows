...
protected:
	...
	VOID LockSendQueue() { ::EnterCriticalSection(&m_csSendQueue); }
	VOID UnlockSendQueue() { ::LeaveCriticalSection(&m_csSendQueue); }
	VOID LockRecvQueue() { ::EnterCriticalSection(&m_csRecvQueue); }
	VOID UnlockRecvQueue() { ::LeaveCriticalSection(&m_csRecvQueue); }
