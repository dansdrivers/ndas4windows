...
public:
	...
	CNBUnitDevice * operator[](int i) { return m_mapUnitDevices[i]; }
};
...
public:
	...
	virtual UINT GetIconIndex() = 0;
	virtual UINT GetSelectIconIndex() = 0;
...
public:
	...
	virtual UINT GetIconIndex();
	virtual UINT GetSelectIconIndex();
...
public:
	CNBLogicalDevice(UINT32 nIndex);
