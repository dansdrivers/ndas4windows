...
#define LANSCSI_RESPONSE_RI_BAD_COMMAND         0x11 // not exist
...
#define LANSCSI_RESPONSE_RI_AUTH_FAILED         0x14 // not exist
#define LANSCSI_RESPONSE_T_NOT_EXIST			0x20 // not exist
#define LANSCSI_RESPONSE_T_BAD_COMMAND          0x21 // frame.vhd : pREP_NO_TARGET
#define LANSCSI_RESPONSE_T_COMMAND_FAILED       0x22 // frame.vhd : cREP_FAIL
#define LANSCSI_RESPONSE_T_BROKEN_DATA			0x23 // not exist
...
#define VENDOR_OP_SET_SEMA					0x05 // frame.vhd : VENDOR_SET_SEMA
#define VENDOR_OP_FREE_SEMA					0x06 // frame.vhd : VENDOR_FREE_SEMA
#define VENDOR_OP_GET_SEMA					0x07 // frame.vhd : VENDOR_GET_SEMA
#define VENDOR_OP_OWNER_SEMA				0x08 // frame.vhd : VENDOR_GET_OWNER_SEMA
