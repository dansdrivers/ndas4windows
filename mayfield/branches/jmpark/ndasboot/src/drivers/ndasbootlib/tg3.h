...
static __inline void *netdev_priv(struct device *dev)
{
	return dev->priv;
}
#endif
...
#ifdef OLD_NETIF
static __inline void netif_poll_disable(struct device *dev)
{
...
static __inline void netif_poll_enable(struct device *dev)
{
	clear_bit(__LINK_STATE_RX_SCHED, &dev->state);
}

static __inline void netif_tx_disable(struct device *dev)
{
...
static __inline struct mii_ioctl_data *if_mii(struct ifreq *rq)
{
...
static __inline int skb_header_cloned(struct sk_buff *skb) { return 0; }
#endif
...
#define SPLIT_MODE_5704_MAX_REQ		3
	...
	KTIMER			timer;	/* Kernel timer struct  */	
	KDPC			timerDpc;	/* Kernel timer struct  */	
	u16				timer_counter;
