...
#define SkCsCalculateChecksum(p,l) 0 // incorrect ~~~
...
*/
#define SK_OUT8(b,a,v)		*((PUCHAR)((b)+(a))) = (UCHAR)(v)	
#define SK_OUT16(b,a,v)		*((PUSHORT)((b)+(a))) = (USHORT)(v)	
#define SK_OUT32(b,a,v)		*((PULONG)((b)+(a))) = (ULONG)(v)	
#define SK_IN8(b,a,pv)		*(pv) = *((PUCHAR)((b)+(a)))
#define SK_IN16(b,a,pv)		*(pv) = *((PUSHORT)((b)+(a)))
#define SK_IN32(b,a,pv)		*(pv) = *((PULONG)((b)+(a)))
...
#define uintptr_t2	unsigned long
