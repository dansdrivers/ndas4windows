...
/* Threshold values for Yukon-EC_U */
#define SK_ECU_ULPP		(1024 / 8)	/* Upper Pause Threshold in muliples of 8 */
#define SK_ECU_LLPP		( 768 / 8)	/* Lower Pause Threshold in muliples of 8 */
#define SK_ECU_AE_THR	0x180		/* Almost Empty Threshold */
...
#define HWF_WA_DEV_4167			0x10040000UL	/*-RMV- 4.167 (Rx Ov Siz Hang)*/
