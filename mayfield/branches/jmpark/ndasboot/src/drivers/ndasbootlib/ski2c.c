...
int		Event)	/* complete event to wait for (I2C_READ or I2C_WRITE) */
{
	...
	do {
		...
		NbDebugPrint(0, ("SkI2cWait: I2cCtrl = %08X\n"));
#ifdef xYUKON_DBG
...
SK_IOC	IoC)	/* I/O Context */
{
	...
	{	
		...
		NbDebugPrint(0, ("SkI2cInit1:B2_I2C_SW = %02X\n", OrgBits));
	}
	...
	NbDebugPrint(0, ("SkI2cInit1:pAC->GIni.GIGenesis = %d, pPrt->PhyType = %d\n", pAC->GIni.GIGenesis, pPrt->PhyType));
	...
	NbDebugPrint(0, ("pAC->I2c.MaxSens = %d\n", pAC->I2c.MaxSens));
...
SK_IOC	IoC)	/* I/O Context */
{
	...
	if (ReadComplete) {
		NbDebugPrint(0, ("SkI2cInit2:ReadComplete = %d\n", ReadComplete));
...
int		Level)	/* Init Level */
{
	...
	NbDebugPrint(0, ("SkI2cInit Entered, Level(%d)\n", Level));
	switch (Level) {
	case SK_INIT_DATA:
	...
	NbDebugPrint(0, ("SkI2cInit Exit, Level(%d)", Level));
...
SK_EVPARA	Para)	/* Event specific Parameter */
{
	...
	NbDebugPrint(0, ("SkI2cEvent: Event = %d\n", Event));
