...
static const lsp_uint8 LSP_RPE_AHS_RECV_FAIL   = 4;
static const lsp_uint8 LSP_RPE_AHS_INVALID_LEN = 5;
static const lsp_uint8 LSP_RPE_DSG_RECV_FAIL   = 6;
static const lsp_uint8 LSP_RPE_DSG_INVALID_LEN = 7;
static const lsp_uint8 LSP_RPE_DAT_RECV_FAIL   = 8;
static const lsp_uint8 LSP_RPE_DAT_INVALID_LEN = 9;
...
#if 1 // use another way to work-around v2.0 bug.
