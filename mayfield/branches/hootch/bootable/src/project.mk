...
# define debug publish directory
# debug publush directory contains non-stripped binary, not like publish directory
NDAS_DBGPUB_PATH=$(NDAS_ROOT)\dbgpub\$(DDKBUILDENV)\$(TARGET_PLATFORM)\$(TARGET_DIRECTORY)
