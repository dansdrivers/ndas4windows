...
#define XDBG_FILENAME "pnpdevinst.cpp"
#define XDBG_LIBRARY_MODULE_FLAG 0x00004000
#include "xdebug.h"
...
/*				DPInfo(_FT("Deleting related registry key.\n"));
				...
				if (!fSuccess) {
					DWORD err = GetLastError();
					DPErrorEx(_FT("SetupDiDeleteDevRegKey failed: 0x%08X"), err);
				}
*/
				//
