...

{
	...
	NdFatSeFilterToken = MmGetSystemRoutineAddress( &functionName );

	RtlInitUnicodeString( &functionName, L"KeAreApcsDisabled" );
	NdFatKeAreApcsDisabled = MmGetSystemRoutineAddress( &functionName );
	
	RtlInitUnicodeString( &functionName, L"FsRtlTeardownPerStreamContexts" );
	NdFatFsRtlTeardownPerStreamContexts = MmGetSystemRoutineAddress( &functionName );

#endif

#ifdef __ND_FAT__
	
    RtlInitUnicodeString( &UnicodeString, L"\\Device\\NdNtfsControl" );
    ...
    RtlInitUnicodeString( &UnicodeString, L"\\NdNtfsCdrom" );
