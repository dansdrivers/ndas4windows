...
int		Level)		/* Initialization level */
{
	...
	case SK_INIT_IO:
		...
		NbDebugPrint(0, ("SkPnmiInit:pAC->Pnmi.PciBusSpeed = %d\n", pAC->Pnmi.PciBusSpeed));
		/* Get PCI bus width. */
		...
		NbDebugPrint(0, ("SkPnmiInit:pAC->Pnmi.PciBusWidth = %d\n", pAC->Pnmi.PciBusWidth));

		NbDebugPrint(0, ("SkPnmiInit:pAC->GIni.GIChipId = %04X\n", pAC->GIni.GIChipId));
		...
		NbDebugPrint(0, ("SkPnmiInit:pAC->GIni.GIPmdTyp = %c\n", pAC->GIni.GIPmdTyp));
		...
		NbDebugPrint(0, ("SkPnmiInit:pAC->GIni.GIConTyp = %c\n", pAC->GIni.GIConTyp));
		/* Get connector type. */
	...
	case SK_INIT_RUN:
		...
		NbDebugPrint(0, ("SkPnmiInit: SK_PNMI_EVT_TIMER_CHECK Timer Start\n"));
...
SK_EVPARA Param)	/* Event dependent parameter */
{
	...
	case SK_PNMI_EVT_RLMT_ACTIVE_UP:
		...
		NbDebugPrint(0, ("SkPnmiEvent: QueueRlmtNewMacTrap Before\n"));
