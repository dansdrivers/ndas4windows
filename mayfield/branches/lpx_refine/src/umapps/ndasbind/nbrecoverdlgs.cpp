...
{ 
	...
	// ConnectionInfo.ui64SupervisorCode = NULL;
	CopyMemory(
		ConnectionInfo.DeviceId.Node, 
		pDlgRecover->m_pDevice->GetLocation()->GetUnitDiskLocation()->MACAddr, 
		sizeof(ConnectionInfo.DeviceId.Node));
