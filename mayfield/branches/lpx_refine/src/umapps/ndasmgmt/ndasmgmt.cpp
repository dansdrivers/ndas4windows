...
#if defined(_AMD64_)
	// AMD64 uses C decorated function name without parameter length
	LPCSTR ApiVersionProc = "NdasGetAPIVersion";
#else
	LPCSTR ApiVersionProc = "_NdasGetAPIVersion@0";
#endif
	FARPROC pProc = ::GetProcAddress(hDll, ApiVersionProc);
	if (NULL == pProc) {
