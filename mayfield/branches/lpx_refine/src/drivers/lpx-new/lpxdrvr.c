...
PDEVICE_CONTEXT  LpxPrimaryDeviceContext; // also guarded by LpxDevicesLock
...

{
    ...
    case IRP_MJ_CLOSE:
        ...
        default:
            IF_LPXDBG (LPX_DEBUG_DISPATCH) {
                LpxPrint1 ("LpxDispatch: IRP_MJ_CLOSE on unknown file type %lx.\n",
    ...
    case IRP_MJ_CLEANUP:
        ...
        default:
            IF_LPXDBG (LPX_DEBUG_DISPATCH) {
                LpxPrint1 ("LpxDispatch: IRP_MJ_CLEANUP on unknown file type %lx.\n",
                    IrpSp->FileObject->FsContext2);
            }
