...
#define NDASCOMM_API_VERSION_MINOR 0x0012
...
/* Summary
   ...
   CopyMemory(ConnectionInfo.NdasId.Id, "ABCDE12345EFGHI67890", 20);
   CopyMemory(ConnectionInfo.NdasId.Key, "12345", 5);
...
/* Summary
   ...
   Use Shared
   For general purpose Shared Write lock
