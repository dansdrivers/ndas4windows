...
!IF exists(d:\development\vendor)
XM_VENDOR_PATH=c:\development\vendor
!ENDIF
!IF exists(d:\development\vendor)
XM_VENDOR_PATH=d:\development\vendor
!ENDIF
!ENDIF
...
!ELSE
!IF [echo BUILDMSG: Declared XM_VENDOR_PATH=$(XM_VENDOR_PATH)]
!ENDIF
!ENDIF
...
!	ELSE
!		IF [echo BUILDMSG: Using dynamic link library to ATL: ATL.LIB]
!		ENDIF
