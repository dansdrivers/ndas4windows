	...
	NDASUSER_DEVICE_INFORMATIONW* pDevInfo)
{
	...
	{
		XTLVERIFY(NdasIdDeviceToStringW(
	...
	PNDASUSER_LOGICALDEVICE_INFORMATIONW pLogDevInfo)
{
	...
	struct Command : NdasCmd<NDAS_CMD_QUERY_LOGICALDEVICE_INFORMATION>
	{
		//
		// output parameter
		//
		...
		{
			NDAS_CMD_QUERY_LOGICALDEVICE_INFORMATION::REQUEST* pRequest = m_pRequest;
			pRequest->LogicalDeviceId = logicalDeviceId;
		}
		BOOL OnSuccess()
		{
			// aliasing just for conveniences
			NDAS_CMD_QUERY_LOGICALDEVICE_INFORMATION::REPLY* pReply = m_pReply;
